...
bool OpenCascadeImporter::addShapeToRegion(const TopoDS_Shape& shape, Cmiss_region_id region, const char *name, const Cad_colour_map& colourMap)
{
	...
	Cmiss_field_set_attribute_integer(cad_topology_field, CMISS_FIELD_ATTRIBUTE_MANAGED, 1);
	...
	Cmiss_field_set_attribute_integer(cad_geometry_field, CMISS_FIELD_ATTRIBUTE_MANAGED, 1);
	...
	Cmiss_field_set_attribute_integer(cad_colour_field, CMISS_FIELD_ATTRIBUTE_MANAGED, 1);

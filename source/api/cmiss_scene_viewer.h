...
/***************************************************************************//**
 * Sets scene_viewer to continuously update the supplied field with the 4x4
 * transformation matrix mapping from_coordinate_system to_coordinate_system.
 * Calling this function with the same field on the same scene_viewer replaces
 * the transformation.
 * Each scene viewer can update any number of fields in different regions,
 * but results are undefined if the same field is set to be updated by more
 * than one scene viewer: do not do this.
 ...
 *
 * @param scene_viewer  handle to Cmiss_scene_viewer object.
 * @param field  16-component real constant field for scene_viewer to write
 * transformation matrix into. Must be a 16-component real constant field.
...
/***************************************************************************//**
 * Removes field from the list of fields which the scene viewer outputs
 * transformations to.
 * @see Cmiss_scene_viewer_set_output_transformation_field.
 *
 * @param scene_viewer  handle to Cmiss_scene_viewer object.
 * @param field  The field to stop outputting to.
 * @return  1 on success, 0 on failure.
 */
...
/***************************************************************************//**
 * Removes all output transformation fields from scene viewer.
 * @see Cmiss_scene_viewer_set_output_transformation_field.
 *
 * @param scene_viewer  handle to Cmiss_scene_viewer object.
 * @return  1 on success, 0 on failure.

/*******************************************************************************
 * cmiss_graphic_filter.h
 * 
 * Public interface to Cmiss_graphic_filter objects for filtering graphics
...
#ifndef __CMISS_GRAPHIC_FILTER_H__
#define __CMISS_GRAPHIC_FILTER_H__
...
/***************************************************************************//**
 * Labels of graphic_filter attributes which may be set or obtained using generic
 * get/set_attribute functions.
 * Note: not all attributes can be set.
 */
enum Cmiss_graphic_filter_attribute_id
{
	CMISS_GRAPHIC_FILTER_ATTRIBUTE_IS_MANAGED = 1,
	/*!< Boolean as integer, when 0 (default) graphic_filter is destroyed when no
	 * longer in use, i.e. when number of external references to it drops to
	 * zero. Set to 1 to manage graphic_filter object indefinitely, or until this
	 * attribute is reset to zero, effectively marking it as pending destruction.
	 */
	CMISS_GRAPHIC_FILTER_ATTRIBUTE_SHOW_MATCHING= 2
};
 ...
 */
Cmiss_graphic_filter_id Cmiss_graphic_filter_access(Cmiss_graphic_filter_id filter);

/*******************************************************************************
 * Destroys this reference to the filter (and sets it to NULL).
 * Internally this just decrements the reference count.
 */
int Cmiss_graphic_filter_destroy(Cmiss_graphic_filter_id *filter_address);
 ...
 */
int Cmiss_graphic_filter_is_active(Cmiss_graphic_filter_id filter);
 ...
 */
int Cmiss_graphic_filter_set_active(Cmiss_graphic_filter_id filter,
	int active_flag);
 ...
 */
int Cmiss_graphic_filter_is_inverse_match(Cmiss_graphic_filter_id filter);
...
/***************************************************************************//**
 * Return an allocated string containing graphic_filter name.
 *
 * @param graphic_filter  handle to the cmiss scene filter.
 * @return  allocated string containing graphic_filter name, or NULL on failure.
 */
char *Cmiss_graphic_filter_get_name(Cmiss_graphic_filter_id filter);
 ...
 * @return  1 on success, 0 on failure.
 */
int Cmiss_graphic_filter_set_name(Cmiss_graphic_filter_id filter,
	const char *name);

/*******************************************************************************
 * Add a filter into a collective Cmiss_graphic_filter.
 *
 * @param filter  The filter to modify.
 * @param filter_to_add  The filter to modify to be added into filter
 * @return  1 on success, 0 on failure.
 */
int Cmiss_graphic_filter_add(Cmiss_graphic_filter_id graphic_filter,
	Cmiss_graphic_filter_id filter_to_add);

/*******************************************************************************
 * Remove a filter from a collective Cmiss_graphic_filter.
 *
 * @param filter  The filter to modify.
 * @param filter_to_remove  The filter to modify to be added into filter
 * @return  1 on success, 0 on failure.
 */
int Cmiss_graphic_filter_remove(Cmiss_graphic_filter_id graphic_filter,
	Cmiss_graphic_filter_id filter_to_remove);

/***************************************************************************//**
 * Creates a Cmiss_graphic_filter which matches any graphic with visibility flag
 ...
 * Caller must call Cmiss_graphic_filter_destroy to clean up the returned handle.
 *
...
/***************************************************************************//**
 * Creates a Cmiss_graphic_filter which matches all graphics.
 * The new filter defaults to being active with action to show matched graphics.
 * Caller must call Cmiss_graphic_filter_destroy to clean up the returned handle.
 *
 * @param scene  Scene to add filter to.
...
/***************************************************************************//**
 * Creates a Cmiss_graphic_filter which matches any graphic with the supplied
...
/***************************************************************************//**
 * Creates a Cmiss_graphic_filter which matches any graphic in region.
 * The new filter defaults to being active with action to show matched graphics.
 * Caller must call Cmiss_graphic_filter_destroy to clean up the returned handle.
 *
...
/***************************************************************************//**
 * Creates a collective of Cmiss_graphic_filters which matches all supplied
 * filters.
 * The new filter defaults to being active with action to show matched graphics.
 * Caller must call Cmiss_graphic_filter_destroy to clean up the returned handle.
 *
...
/***************************************************************************//**
 * Creates a collective of Cmiss_graphic_filters which matches any of the supplied
 * filters.
 * The new filter defaults to being active with action to show matched graphics.
 * Caller must call Cmiss_graphic_filter_destroy to clean up the returned handle.
 *
...
/***************************************************************************//**
 * Set an integer or Boolean attribute of the graphic_filter object.
 *
 * @param graphic_filter  Handle to the cmiss graphic_filter.
 ...
 * or able to be set for this graphic_filter object.
 */
...
#endif /*__CMISS_GRAPHIC_FILTER_H__*/

...
static char graphical_element_editor_uidh[] =
					...
					gelem_editor->current_settings_type)
				{
						...
						Computed_field_is_scalar,(void *)NULL,computed_field_manager))
					{
						...
						if (!GT_element_settings_set_iso_surface_parameters(settings,
							...
							/*first_iso_value*/0.0,/*last_iso_value*/0.0,/*decimation_threshold*/0.0))
						{
							return_code=0;
						}
					}
...
==============================================================================*/
{
	...
	{
		if (MrmOpenHierarchy_binary_string(graphical_element_editor_uidh,sizeof(graphical_element_editor_uidh),

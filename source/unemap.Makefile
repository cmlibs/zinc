...
BIN_TARGET = $(TARGET_EXECUTABLE_BASENAME)$(TARGET_ABI_SUFFIX)$(TARGET_UNEMAP_TYPE_SUFFIX)$(TARGET_USER_INTERFACE_SUFFIX)$(TARGET_DYNAMIC_GL_SUFFIX)$(TARGET_DEBUG_SUFFIX)$(TARGET_MEMORYCHECK_SUFFIX)$(TARGET_FILETYPE_SUFFIX)
...
depend :
	...
	(makedepend -f $(DEPENDFILE) -o.o -Y -a -- $(ALL_FLAGS) -- $(SRCS) 2>> $(DEPENDFILE).tmp)
	(makedepend -f $(DEPENDFILE) -o.o -Y -a -- $(ALL_FLAGS) -- $(UTILITIES_SRCS) 2>> $(DEPENDFILE).tmp)
ifeq ($(USER_INTERFACE), MOTIF_USER_INTERFACE)
...
utilities : $(UNEMAP_UTILITIES_PATH)/Affine
utilities : $(UNEMAP_UTILITIES_PATH)/AnalysisCalculateLib 
utilities : $(UNEMAP_UTILITIES_PATH)/Bmsi2sig 
utilities : $(UNEMAP_UTILITIES_PATH)/Biosense2sig 
utilities : $(UNEMAP_UTILITIES_PATH)/Biosense2vrml
utilities : $(UNEMAP_UTILITIES_PATH)/CalculateEvents 
utilities : $(UNEMAP_UTILITIES_PATH)/ChangeCalibration 
utilities : $(UNEMAP_UTILITIES_PATH)/ChangeChannels 
utilities : $(UNEMAP_UTILITIES_PATH)/ChangeConfiguration
utilities : $(UNEMAP_UTILITIES_PATH)/ChangeEvents 
utilities : $(UNEMAP_UTILITIES_PATH)/ChangeFrequency 
utilities : $(UNEMAP_UTILITIES_PATH)/CombineSignals 
utilities : $(UNEMAP_UTILITIES_PATH)/DifferenceSignals 
utilities : $(UNEMAP_UTILITIES_PATH)/ExtractSignal
utilities : $(UNEMAP_UTILITIES_PATH)/FixEcg
utilities : $(UNEMAP_UTILITIES_PATH)/Img2sig 
utilities : $(UNEMAP_UTILITIES_PATH)/MakePlaque 
utilities : $(UNEMAP_UTILITIES_PATH)/OpticalSignals 
utilities : $(UNEMAP_UTILITIES_PATH)/Plt2cnfg 
utilities : $(UNEMAP_UTILITIES_PATH)/Posdat2sig
utilities : $(UNEMAP_UTILITIES_PATH)/RatioSignals 
utilities : $(UNEMAP_UTILITIES_PATH)/Register 
utilities : $(UNEMAP_UTILITIES_PATH)/Sig2text 
utilities : $(UNEMAP_UTILITIES_PATH)/TestDelaunay 
utilities : $(UNEMAP_UTILITIES_PATH)/TestUnemapHardware 
utilities : $(UNEMAP_UTILITIES_PATH)/Text2sig
utilities : $(UNEMAP_UTILITIES_PATH)/Tuff2sig 
utilities : $(UNEMAP_UTILITIES_PATH)/UniqueChannels
...
BUILD_AFFINE = $(call BuildNormalTarget,Affine,$(UNEMAP_UTILITIES_PATH),AFFINE_OBJS,-lm) 

$(UNEMAP_UTILITIES_PATH)/Affine: $(AFFINE_OBJS)
	$(BUILD_AFFINE)
...
BUILD_ANALYSIS_CALCULATE_LIB = $(call BuildLibraryTarget,AnalysisCalculateLib,$(UNEMAP_UTILITIES_PATH),ANALYSIS_CALCULATE_LIB_OBJS,) 

$(UNEMAP_UTILITIES_PATH)/AnalysisCalculateLib: $(ANALYSIS_CALCULATE_LIB_OBJS)
...
BUILD_BMSI2SIG = $(call BuildNormalTarget,Bmsi2sig,$(UNEMAP_UTILITIES_PATH),BMSI2SIG_OBJS,-lm) 

$(UNEMAP_UTILITIES_PATH)/Bmsi2sig: $(BMSI2SIG_OBJS)
	$(BUILD_BMSI2SIG)
...
BUILD_BIOSENSE2SIG = $(call BuildNormalTarget,Biosense2sig,$(UNEMAP_UTILITIES_PATH),BIOSENSE2SIG_OBJS,-lm) 

$(UNEMAP_UTILITIES_PATH)/Biosense2sig: $(BIOSENSE2SIG_OBJS)
	$(BUILD_BIOSENSE2SIG)
...
BUILD_BIOSENSE2VRML = $(call BuildNormalTarget,Biosense2vrml,$(UNEMAP_UTILITIES_PATH),BIOSENSE2VRML_OBJS,-lm) 

$(UNEMAP_UTILITIES_PATH)/Biosense2vrml: $(BIOSENSE2VRML_OBJS)
	$(BUILD_BIOSENSE2VRML)
...
BUILD_CALCULATE_EVENTS = $(call BuildNormalTarget,CalculateEvents,$(UNEMAP_UTILITIES_PATH),CALCULATE_EVENTS_OBJS,-lm) 

$(UNEMAP_UTILITIES_PATH)/CalculateEvents: $(CALCULATE_EVENTS_OBJS)
...
BUILD_CHANGE_CALIBRATION = $(call BuildNormalTarget,ChangeCalibration,$(UNEMAP_UTILITIES_PATH),CHANGE_CALIBRATION_OBJS,-lm) 

$(UNEMAP_UTILITIES_PATH)/ChangeCalibration: $(CHANGE_CALIBRATION_OBJS)
...
BUILD_CHANGE_CHANNELS = $(call BuildNormalTarget,ChangeChannels,$(UNEMAP_UTILITIES_PATH),CHANGE_CHANNELS_OBJS,-lm) 

$(UNEMAP_UTILITIES_PATH)/ChangeChannels: $(CHANGE_CHANNELS_OBJS)
...
BUILD_CHANGE_CONFIGURATION = $(call BuildNormalTarget,ChangeConfiguration,$(UNEMAP_UTILITIES_PATH),CHANGE_CONFIGURATION_OBJS,-lm) 

$(UNEMAP_UTILITIES_PATH)/ChangeConfiguration: $(CHANGE_CONFIGURATION_OBJS)
...
BUILD_CHANGE_EVENTS = $(call BuildNormalTarget,ChangeEvents,$(UNEMAP_UTILITIES_PATH),CHANGE_EVENTS_OBJS,-lm) 

$(UNEMAP_UTILITIES_PATH)/ChangeEvents: $(CHANGE_EVENTS_OBJS)
	$(BUILD_CHANGE_EVENTS)
...
BUILD_CHANGE_FREQUENCY = $(call BuildNormalTarget,ChangeFrequency,$(UNEMAP_UTILITIES_PATH),CHANGE_FREQUENCY_OBJS,-lm) 

$(UNEMAP_UTILITIES_PATH)/ChangeFrequency: $(CHANGE_FREQUENCY_OBJS)
...
BUILD_COMBINE_SIGNALS = $(call BuildNormalTarget,CombineSignals,$(UNEMAP_UTILITIES_PATH),COMBINE_SIGNALS_OBJS,-lm) 

$(UNEMAP_UTILITIES_PATH)/CombineSignals: $(COMBINE_SIGNALS_OBJS)
...
BUILD_DIFFERENCE_SIGNALS = $(call BuildNormalTarget,DifferenceSignals,$(UNEMAP_UTILITIES_PATH),DIFFERENCE_SIGNALS_OBJS,-lm) 

$(UNEMAP_UTILITIES_PATH)/DifferenceSignals: $(DIFFERENCE_SIGNALS_OBJS)
...
BUILD_EXTRACT_SIGNAL = $(call BuildNormalTarget,ExtractSignal,$(UNEMAP_UTILITIES_PATH),EXTRACT_SIGNAL_OBJS,-lm) 

$(UNEMAP_UTILITIES_PATH)/ExtractSignal: $(EXTRACT_SIGNAL_OBJS)
...
BUILD_FIX_ECG = $(call BuildNormalTarget,FixEcg,$(UNEMAP_UTILITIES_PATH),FIX_ECG_OBJS,-lm) 

$(UNEMAP_UTILITIES_PATH)/FixEcg: $(FIX_ECG_OBJS)
	$(BUILD_FIX_ECG)
...
BUILD_IMG2SIG = $(call BuildNormalTarget,Img2sig,$(UNEMAP_UTILITIES_PATH),IMG2SIG_OBJS,-lm) 

$(UNEMAP_UTILITIES_PATH)/Img2sig: $(IMG2SIG_OBJS)
	$(BUILD_IMG2SIG)
...
BUILD_MAKE_PLAQUE = $(call BuildNormalTarget,MakePlaque,$(UNEMAP_UTILITIES_PATH),MAKE_PLAQUE_OBJS,-lm) 

$(UNEMAP_UTILITIES_PATH)/MakePlaque: $(MAKE_PLAQUE_OBJS)
	$(BUILD_MAKE_PLAQUE)
...
BUILD_OPTICAL_SIGNALS = $(call BuildNormalTarget,OpticalSignals,$(UNEMAP_UTILITIES_PATH),OPTICAL_SIGNALS_OBJS,-lm) 

$(UNEMAP_UTILITIES_PATH)/OpticalSignals: $(OPTICAL_SIGNALS_OBJS)
...
BUILD_PLT2CNFG = $(call BuildNormalTarget,Plt2cnfg,$(UNEMAP_UTILITIES_PATH),PLT2CNFG_OBJS,-lm) 

$(UNEMAP_UTILITIES_PATH)/Plt2cnfg: $(PLT2CNFG_OBJS)
	$(BUILD_PLT2CNFG)
...
BUILD_POSDAT2SIG = $(call BuildNormalTarget,Posdat2sig,$(UNEMAP_UTILITIES_PATH),POSDAT2SIG_OBJS,-lm)

$(UNEMAP_UTILITIES_PATH)/Posdat2sig: $(POSDAT2SIG_OBJS)
	$(BUILD_POSDAT2SIG)
...
BUILD_RATIO_SIGNALS = $(call BuildNormalTarget,RatioSignals,$(UNEMAP_UTILITIES_PATH),RATIO_SIGNALS_OBJS,-lm)

$(UNEMAP_UTILITIES_PATH)/RatioSignals: $(RATIO_SIGNALS_OBJS)
	$(BUILD_RATIO_SIGNALS)
...
BUILD_REGISTER = $(call BuildNormalTarget,Register,$(UNEMAP_UTILITIES_PATH),REGISTER_OBJS,$(LIB))

$(UNEMAP_UTILITIES_PATH)/Register: $(REGISTER_OBJS)
	$(BUILD_REGISTER)
...
BUILD_SIG2TEXT = $(call BuildNormalTarget,Sig2text,$(UNEMAP_UTILITIES_PATH),SIG2TEXT_OBJS,-lm)

$(UNEMAP_UTILITIES_PATH)/Sig2text: $(SIG2TEXT_OBJS)
	$(BUILD_SIG2TEXT)
...
BUILD_TEST_DELAUNAY = $(call BuildNormalTarget,TestDelaunay,$(UNEMAP_UTILITIES_PATH),TEST_DELAUNAY_OBJS,-lm)

$(UNEMAP_UTILITIES_PATH)/TestDelaunay: $(TEST_DELAUNAY_OBJS)
	$(BUILD_TEST_DELAUNAY)
...
BUILD_TEST_UNEMAP_HARDWARE = $(call BuildNormalTarget,TestUnemapHardware,$(UNEMAP_UTILITIES_PATH),TEST_UNEMAP_HARDWARE_OBJS,$(LIB))

$(UNEMAP_UTILITIES_PATH)/TestUnemapHardware: $(TEST_UNEMAP_HARDWARE_OBJS)
...
BUILD_TEXT2SIG = $(call BuildNormalTarget,Text2sig,$(UNEMAP_UTILITIES_PATH),TEXT2SIG_OBJS,-lm)

$(UNEMAP_UTILITIES_PATH)/Text2sig: $(TEXT2SIG_OBJS)
	$(BUILD_TEXT2SIG)
...
BUILD_TUFF2SIG = $(call BuildNormalTarget,Tuff2sig,$(UNEMAP_UTILITIES_PATH),TUFF2SIG_OBJS,-lm)

$(UNEMAP_UTILITIES_PATH)/Tuff2sig: $(TUFF2SIG_OBJS)
	$(BUILD_TUFF2SIG)
...
BUILD_UNIQUE_CHANNELS = $(call BuildNormalTarget,UniqueChannels,$(UNEMAP_UTILITIES_PATH),UNIQUE_CHANNELS_OBJS,-lm)

$(UNEMAP_UTILITIES_PATH)/UniqueChannels: $(UNIQUE_CHANNELS_OBJS)

...
utilities : Affine AnalysisCalculateLib Bmsi2sig Biosense2sig Biosense2vrml \
CalculateEvents ChangeCalibration ChangeChannels ChangeConfiguration \
ChangeEvents ChangeFrequency CombineSignals DifferenceSignals ExtractSignal \
FixEcg Img2sig MakePlaque OpticalSignals Plt2cnfg Posdat2sig \
RatioSignals Register Sig2text TestDelaunay TestUnemapHardware Text2sig \
Tuff2sig UniqueChannels
...
BUILD_AFFINE = $(call BuildNormalTarget,Affine,$(UTILITIES_PATH),AFFINE_OBJS,-lm) 
...
BUILD_ANALYSIS_CALCULATE_LIB = $(call BuildLibraryTarget,AnalysisCalculateLib,$(UTILITIES_PATH),ANALYSIS_CALCULATE_LIB_OBJS,) 

AnalysisCalculateLib: $(ANALYSIS_CALCULATE_LIB_OBJS)
...
BUILD_BMSI2SIG = $(call BuildNormalTarget,Bmsi2sig,$(UTILITIES_PATH),BMSI2SIG_OBJS,-lm) 

Bmsi2sig: $(BMSI2SIG_OBJS)
	$(BUILD_BMSI2SIG)
...
BUILD_BIOSENSE2SIG = $(call BuildNormalTarget,Biosense2sig,$(UTILITIES_PATH),BIOSENSE2SIG_OBJS,-lm) 

Biosense2sig: $(BIOSENSE2SIG_OBJS)
	$(BUILD_BIOSENSE2SIG)
...
BUILD_BIOSENSE2VRML = $(call BuildNormalTarget,Biosense2vrml,$(UTILITIES_PATH),BIOSENSE2VRML_OBJS,-lm) 

Biosense2vrml: $(BIOSENSE2VRML_OBJS)
	$(BUILD_BIOSENSE2VRML)
...
BUILD_CALCULATE_EVENTS = $(call BuildNormalTarget,CalculateEvents,$(UTILITIES_PATH),CALCULATE_EVENTS_OBJS,-lm) 

CalculateEvents: $(CALCULATE_EVENTS_OBJS)
...
BUILD_CHANGE_CALIBRATION = $(call BuildNormalTarget,ChangeCalibration,$(UTILITIES_PATH),CHANGE_CALIBRATION_OBJS,-lm) 

ChangeCalibration: $(CHANGE_CALIBRATION_OBJS)
...
BUILD_CHANGE_CHANNELS = $(call BuildNormalTarget,ChangeChannels,$(UTILITIES_PATH),CHANGE_CHANNELS_OBJS,-lm) 

ChangeChannels: $(CHANGE_CHANNELS_OBJS)
...
BUILD_CHANGE_CONFIGURATION = $(call BuildNormalTarget,ChangeConfiguration,$(UTILITIES_PATH),CHANGE_CONFIGURATION_OBJS,-lm) 
ChangeConfiguration: $(CHANGE_CONFIGURATION_OBJS)
...
BUILD_CHANGE_EVENTS = $(call BuildNormalTarget,ChangeEvents,$(UTILITIES_PATH),CHANGE_EVENTS_OBJS,-lm) 

ChangeEvents: $(CHANGE_EVENTS_OBJS)
	$(BUILD_CHANGE_EVENTS)
...
BUILD_CHANGE_FREQUENCY = $(call BuildNormalTarget,ChangeFrequency,$(UTILITIES_PATH),CHANGE_FREQUENCY_OBJS,-lm) 

ChangeFrequency: $(CHANGE_FREQUENCY_OBJS)
...
BUILD_COMBINE_SIGNALS = $(call BuildNormalTarget,CombineSignals,$(UTILITIES_PATH),COMBINE_SIGNALS_OBJS,-lm) 

CombineSignals: $(COMBINE_SIGNALS_OBJS)
...
BUILD_DIFFERENCE_SIGNALS = $(call BuildNormalTarget,DifferenceSignals,$(UTILITIES_PATH),DIFFERENCE_SIGNALS_OBJS,-lm) 

DifferenceSignals: $(DIFFERENCE_SIGNALS_OBJS)
...
BUILD_EXTRACT_SIGNAL = $(call BuildNormalTarget,ExtractSignal,$(UTILITIES_PATH),EXTRACT_SIGNAL_OBJS,-lm) 

ExtractSignal: $(EXTRACT_SIGNAL_OBJS)
...
BUILD_FIX_ECG = $(call BuildNormalTarget,FixEcg,$(UTILITIES_PATH),FIX_ECG_OBJS,-lm) 
...
BUILD_IMG2SIG = $(call BuildNormalTarget,Img2sig,$(UTILITIES_PATH),IMG2SIG_OBJS,-lm) 

Img2sig: $(IMG2SIG_OBJS)
	$(BUILD_IMG2SIG)
...
BUILD_MAKE_PLAQUE = $(call BuildNormalTarget,MakePlaque,$(UTILITIES_PATH),MAKE_PLAQUE_OBJS,-lm) 

MakePlaque: $(MAKE_PLAQUE_OBJS)
	$(BUILD_MAKE_PLAQUE)
...
BUILD_OPTICAL_SIGNALS = $(call BuildNormalTarget,OpticalSignals,$(UTILITIES_PATH),OPTICAL_SIGNALS_OBJS,-lm) 

OpticalSignals: $(OPTICAL_SIGNALS_OBJS)
...
BUILD_PLT2CNFG = $(call BuildNormalTarget,Plt2cnfg,$(UTILITIES_PATH),PLT2CNFG_OBJS,-lm) 

Plt2cnfg: $(PLT2CNFG_OBJS)
	$(BUILD_PLT2CNFG)
...
BUILD_POSDAT2SIG = $(call BuildNormalTarget,Posdat2sig,$(UTILITIES_PATH),POSDAT2SIG_OBJS,-lm)

Posdat2sig: $(POSDAT2SIG_OBJS)
	$(BUILD_POSDAT2SIG)
...
BUILD_RATIO_SIGNALS = $(call BuildNormalTarget,RatioSignals,$(UTILITIES_PATH),RATIO_SIGNALS_OBJS,-lm)

RatioSignals: $(RATIO_SIGNALS_OBJS)
	$(BUILD_RATIO_SIGNALS)
...
BUILD_REGISTER = $(call BuildNormalTarget,Register,$(UTILITIES_PATH),REGISTER_OBJS,-lm)

Register: $(REGISTER_OBJS)
	$(BUILD_REGISTER)
...
BUILD_SIG2TEXT = $(call BuildNormalTarget,Sig2text,$(UTILITIES_PATH),SIG2TEXT_OBJS,-lm)

Sig2text: $(SIG2TEXT_OBJS)
	$(BUILD_SIG2TEXT)
...
BUILD_TEST_DELAUNAY = $(call BuildNormalTarget,TestDelaunay,$(UTILITIES_PATH),TEST_DELAUNAY_OBJS,-lm)

TestDelaunay: $(TEST_DELAUNAY_OBJS)
	$(BUILD_TEST_DELAUNAY)
...
BUILD_TEST_UNEMAP_HARDWARE = $(call BuildNormalTarget,TestUnemapHardware,$(UTILITIES_PATH),TEST_UNEMAP_HARDWARE_OBJS,$(LIB))

TestUnemapHardware: $(TEST_UNEMAP_HARDWARE_OBJS)
...
TEST2SIG_OBJSA = $(TEST2SIG_SRCS:.c=.o)
TEST2SIG_OBJSB = $(TEST2SIG_OBJSA:.cpp=.o)
TEST2SIG_OBJS = $(TEST2SIG_OBJSB:.f=.o)
BUILD_TEST2SIG = $(call BuildNormalTarget,Test2sig,$(UTILITIES_PATH),TEST2SIG_OBJS,-lm)

Test2sig: $(TEST2SIG_OBJS)
	$(BUILD_TEST2SIG)
...
BUILD_TUFF2SIG = $(call BuildNormalTarget,Tuff2sig,$(UTILITIES_PATH),TUFF2SIG_OBJS,-lm)

Tuff2sig: $(TUFF2SIG_OBJS)
	$(BUILD_TUFF2SIG)
...
BUILD_UNIQUE_CHANNELS = $(call BuildNormalTarget,Unique_Channels,$(UTILITIES_PATH),UNIQUE_CHANNELS_OBJS,-lm)

Unique_Channels: $(UNIQUE_CHANNELS_OBJS)

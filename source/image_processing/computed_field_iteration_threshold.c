...
int Computed_field_iteration_threshold_get_native_resolution(struct Computed_field *field,
...
{       
	...
	ENTER(Computed_field_iteration_threshold_get_native_resolution);
	if (field && (data =
		(struct Computed_field_iteration_threshold_type_specific_data *)
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_iteration_threshold_get_native_resolution.  Missing field");
		return_code=0;
	}

	return (return_code);
} /* Computed_field_iteration_threshold_get_native_resolution */
		...
		if (return_code)
		{
			...
			if (return_code)
			{
				return_code = Computed_field_set_type_iteration_threshold(field,
					...
					computed_field_iteration_threshold_package->graphics_buffer_package);
			}
			if (!return_code)
			{
...
==============================================================================*/
{
	...
	if (computed_field_package)
	{
		...
		computed_field_iteration_threshold_package.graphics_buffer_package = graphics_buffer_package;

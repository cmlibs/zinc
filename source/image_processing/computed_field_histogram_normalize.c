...
int Computed_field_get_type_histogram_normalize(struct Computed_field *field,
	struct Computed_field **source_field,
	struct Computed_field **texture_coordinate_field,
	int *number_of_bins, int *dimension, int **sizes, FE_value **minimums,
...
==============================================================================*/
{
	...
	int dimension, element_dimension, number_of_bins, return_code, *sizes;
		...
		if (return_code)
		{
			...
			if (return_code)
			{
				return_code = Computed_field_set_type_histogram_normalize(field,
					source_field, texture_coordinate_field, number_of_bins, dimension,

/******************************************************************
  ...
  The method is based on Chan's algorithm 'Active contour without edge'.
  Reference: Tony Chan and L. Vese, 2001. "Active Contours Without Edges", 
             IEEE trans. on Image Processing, Vol. 10, No. 2, pp.266-277. 
==================================================================*/
/* ***** BEGIN LICENSE BLOCK *****
...
DESCRIPTION :
Perform region segmentation on the image cache.The method is based on Chan's algorithm
'Active contour without edge'.
Reference: Tony Chan and L. Vese, 2001. "Active Contours Without Edges", IEEE trans. on 
           Image Processing, Vol. 10, No. 2, pp.266-277. 
==============================================================================*/
{
	char *storage;
...
int Computed_field_set_type_chan_contour(struct Computed_field *field,
	...
	struct Computed_field *texture_coordinate_field,
	int iteration_times, int dimension, int *sizes, 
	struct MANAGER(Computed_field) *computed_field_manager,
...
{
	char *current_token;
	int dimension, iteration_times, return_code, *sizes;

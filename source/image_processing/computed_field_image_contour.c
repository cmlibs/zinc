...
==============================================================================*/
{
	...
	int filter_size, i, j, k, l, *offsets, return_code, kernel_size, radius, storage_size;
		...
		if (return_code)
		{
			...
			if (return_code)
			{
				return_code = Computed_field_set_type_image_contour(field,
					...
					computed_field_image_contour_package->user_interface);
			}
			if (!return_code)
			{
...
==============================================================================*/
{
	...
	if (computed_field_package)
	{
		...
		computed_field_image_contour_package.user_interface = user_interface;

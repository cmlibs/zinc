/******************************************************************
  FILE: computed_field_spatial_skeleton.c

  LAST MODIFIED: 8 September 2004

  DESCRIPTION:Implement skeleton extraction of 3d image
==================================================================*/
#include <math.h>
...
struct Computed_field_spatial_skeleton_package
/*******************************************************************************
...
struct Computed_field_spatial_skeleton_type_specific_data
{
...
static char computed_field_spatial_skeleton_type_string[] = "spatial_skeleton";

int Computed_field_is_type_spatial_skeleton(struct Computed_field *field)
/*******************************************************************************
...
==============================================================================*/
{
	...
	ENTER(Computed_field_is_type_spatial_skeleton);
	if (field)
	{
		return_code =
		  (field->type_string == computed_field_spatial_skeleton_type_string);
	}
	else
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_is_type_spatial_skeleton.  Missing field");
		return_code = 0;
	}

	return (return_code);
} /* Computed_field_is_type_spatial_skeleton */

static void Computed_field_spatial_skeleton_field_change(
...
==============================================================================*/
{
	...
	struct Computed_field_spatial_skeleton_type_specific_data *data;

	ENTER(Computed_field_spatial_skeleton_source_field_change);
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_spatial_skeleton_source_field_change.  "
			"Invalid arguments.");
	}
	LEAVE;
} /* Computed_field_spatial_skeleton_source_field_change */

static int Computed_field_spatial_skeleton_clear_type_specific(
	struct Computed_field *field)
/*******************************************************************************
LAST MODIFIED : 6 January 2004
...
==============================================================================*/
{
	...
	ENTER(Computed_field_spatial_skeleton_clear_type_specific);
	if (field && (data =
		(struct Computed_field_spatial_skeleton_type_specific_data *)
		field->type_specific_data))
	{
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_spatial_skeleton_clear_type_specific.  "
			"Invalid arguments.");
		return_code = 0;
	}
	LEAVE;
...
static void *Computed_field_spatial_skeleton_copy_type_specific(
...
==============================================================================*/
{
	struct Computed_field_spatial_skeleton_type_specific_data *destination,
		*source;

	ENTER(Computed_field_spatial_skeleton_copy_type_specific);
	if (source_field && destination_field && (source =
		(struct Computed_field_spatial_skeleton_type_specific_data *)
		source_field->type_specific_data))
	{
		if (ALLOCATE(destination,
			struct Computed_field_spatial_skeleton_type_specific_data, 1))
		{
			destination->thinness = source->thinness;
			...
			destination->computed_field_manager_callback_id =
				...
				Computed_field_spatial_skeleton_field_change, (void *)destination_field,
		...
		{
			display_message(ERROR_MESSAGE,
				"Computed_field_spatial_skeleton_copy_type_specific.  "
...
int Computed_field_spatial_skeleton_clear_cache_type_specific
   (struct Computed_field *field)
/*******************************************************************************
LAST MODIFIED : 6 January 2004
...
static int Computed_field_spatial_skeleton_type_specific_contents_match(
...
==============================================================================*/
{
	...
	ENTER(Computed_field_spatial_skeleton_type_specific_contents_match);
	...
	{
		if ((data->thinness == other_data->thinness) &&
	...
	return (return_code);
} /* Computed_field_spatial_skeleton_type_specific_contents_match */

#define Computed_field_spatial_skeleton_is_defined_in_element \
...
#define Computed_field_spatial_skeleton_is_defined_at_node \
...
#define Computed_field_spatial_skeleton_has_numerical_components \
...
#define Computed_field_spatial_skeleton_not_in_use \
...
static int Image_cache_spatial_skeleton(struct Image_cache *image, double thinness)
/*******************************************************************************
LAST MODIFIED : 17 March 2004

DESCRIPTION : Implement image skeleton extracting.
...
==============================================================================*/
{
	...
	if (image && (image->dimension > 0) && (image->depth > 0))
	{
				...
				else
				{
					...
					vertex = 1.0;
			                for (j = 0 ; j < stencil_size ; j++)
				        {
					         ...
					         {
					                  stencil[j] = *(data_index + offsets[j]);
					         }
				         }
                                         face = stencil[4] * stencil[10] * stencil[12] * stencil[14] * stencil[16] *stencil[22];
					 edge = stencil[1] *stencil[3] * stencil[5] * stencil[7] * stencil[9] * stencil[11] *stencil[15]*stencil[17] * stencil[19] * stencil[21] * stencil[23] * stencil[25];
					 vertex = stencil[0] * stencil[2] * stencil[6] * stencil[8] * stencil[18] *stencil[20]* stencil[24] *stencil[26];
					 if (face == 0.0)
					 {
                                                 for (k=0;k<image->depth;k++)
						 {
		...
		{
			display_message(ERROR_MESSAGE,
				"Image_cache_skeleton_detection.  Not enough memory");
			return_code = 0;
		}
	}
	else
	{
		display_message(ERROR_MESSAGE, "Image_cache_skeleton_detection.  "
			"Invalid arguments.");
		return_code=0;
	}
	LEAVE;
	...
	return (return_code);
} /* Image_cache_spatial_skeleton */

static int Computed_field_spatial_skeleton_evaluate_cache_at_node(
...
==============================================================================*/
{
	...
	ENTER(Computed_field_spatial_skeleton_evaluate_cache_at_node);
	if (field && node &&
		(data = (struct Computed_field_spatial_skeleton_type_specific_data *)field->type_specific_data))
	{
		return_code = 1;
		...
		if (!data->image->valid)
		{
			...
			return_code = Image_cache_spatial_skeleton(data->image, data->thinness);
		}
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_spatial_skeleton_evaluate_cache_at_node.  "
			"Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;
...
static int Computed_field_spatial_skeleton_evaluate_cache_in_element(
...
==============================================================================*/
{
	...
	ENTER(Computed_field_spatial_skeleton_evaluate_cache_in_element);
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_spatial_skeleton_evaluate_cache_in_element.  "
			"Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;
...
#define Computed_field_spatial_skeleton_evaluate_as_string_at_node \
...
#define Computed_field_spatial_skeleton_evaluate_as_string_in_element \
...
#define Computed_field_spatial_skeleton_set_values_at_node \
...
#define Computed_field_spatial_skeleton_set_values_in_element \
...
#define Computed_field_spatial_skeleton_get_native_discretization_in_element \
...
#define Computed_field_spatial_skeleton_find_element_xi \
...
int Computed_field_spatial_skeleton_get_native_resolution(struct Computed_field *field,
...
{       
	...
	ENTER(Computed_field_spatial_skeleton_get_native_resolution);
	if (field && (data =
		(struct Computed_field_spatial_skeleton_type_specific_data *)
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_spatial_skeleton_get_native_resolution.  Missing field");
		return_code=0;
	}

	return (return_code);
} /* Computed_field_spatial_skeleton_get_native_resolution */

static int list_Computed_field_spatial_skeleton(
	struct Computed_field *field)
/*******************************************************************************
...
==============================================================================*/
{
	...
	ENTER(List_Computed_field_spatial_skeleton);
	if (field && (field->type_string==computed_field_spatial_skeleton_type_string)
		&& (data = (struct Computed_field_spatial_skeleton_type_specific_data *)
		field->type_specific_data))
	{
	...
	{
		display_message(ERROR_MESSAGE,
			"list_Computed_field_spatial_skeleton.  Invalid field");
		return_code = 0;
	}
	LEAVE;

	return (return_code);
} /* list_Computed_field_spatial_skeleton */

static char *Computed_field_spatial_skeleton_get_command_string(
	struct Computed_field *field)
/*******************************************************************************
LAST MODIFIED : 4 December 2003
...
==============================================================================*/
{
	...
	ENTER(Computed_field_spatial_skeleton_get_command_string);
		...
		field->type_specific_data) )
	{
		...
		append_string(&command_string,
			computed_field_spatial_skeleton_type_string, &error);
		...
		sprintf(temp_string, " thinness %f", data->thinness);
		append_string(&command_string, temp_string, &error);
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_spatial_skeleton_get_command_string.  Invalid field");
	}
	LEAVE;

	return (command_string);
} /* Computed_field_spatial_skeleton_get_command_string */

#define Computed_field_spatial_skeleton_has_multiple_times \
...
int Computed_field_set_type_spatial_skeleton(struct Computed_field *field,
...
DESCRIPTION :
Converts <field> to type COMPUTED_FIELD_spatial_skeleton with the supplied
fields, <source_field> and <texture_coordinate_field>.  The <thinness> specifies
...
==============================================================================*/
{
	...
	ENTER(Computed_field_set_type_spatial_skeleton);
	if (field && source_field && texture_coordinate_field &&
		(thinness > 0) && (depth = source_field->number_of_components) &&
		...
		region && graphics_buffer_package)
	{
		...
		data = (struct Computed_field_spatial_skeleton_type_specific_data *)NULL;
		if (ALLOCATE(source_fields, struct Computed_field *, number_of_source_fields) &&
			ALLOCATE(data, struct Computed_field_spatial_skeleton_type_specific_data, 1) &&
			...
			Image_cache_update_data_storage(data->image))
		{
			...
			data->computed_field_manager_callback_id =
				MANAGER_REGISTER(Computed_field)(
				Computed_field_spatial_skeleton_field_change, (void *)field,
				computed_field_manager);

			field->type_specific_data = data;

			/* Set all the methods */
			COMPUTED_FIELD_ESTABLISH_METHODS(spatial_skeleton);
		}
		else
		{
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_set_type_spatial_skeleton.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

	return (return_code);
} /* Computed_field_set_type_spatial_skeleton */

int Computed_field_get_type_spatial_skeleton(struct Computed_field *field,
	struct Computed_field **source_field,
	struct Computed_field **texture_coordinate_field,
	double *thinness, int *dimension, int **sizes, FE_value **minimums,
	FE_value **maximums, int *element_dimension)
/*******************************************************************************
LAST MODIFIED : 17 December 2003

DESCRIPTION :
If the field is of type COMPUTED_FIELD_spatial_skeleton, the
...
==============================================================================*/
{
	...
	ENTER(Computed_field_get_type_spatial_skeleton);
	if (field && (field->type_string==computed_field_spatial_skeleton_type_string)
		&& (data = (struct Computed_field_spatial_skeleton_type_specific_data *)
		field->type_specific_data) && data->image)
	{
		*dimension = data->image->dimension;
		...
		{
			display_message(ERROR_MESSAGE,
				"Computed_field_get_type_spatial_skeleton.  Unable to allocate vectors.");
			return_code = 0;
		}
	}
	else
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_get_type_spatial_skeleton.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

	return (return_code);
} /* Computed_field_get_type_spatial_skeleton */

static int define_Computed_field_type_spatial_skeleton(struct Parse_state *state,
	void *field_void, void *computed_field_spatial_skeleton_package_void)
/*******************************************************************************
LAST MODIFIED : 4 December 2003

DESCRIPTION :
Converts <field> into type COMPUTED_FIELD_spatial_skeleton (if it is not
...
==============================================================================*/
{
	...
	struct Computed_field_spatial_skeleton_package
		*computed_field_spatial_skeleton_package;
	struct Option_table *option_table;
	struct Set_Computed_field_conditional_data set_source_field_data,
		set_texture_coordinate_field_data;

	ENTER(define_Computed_field_type_spatial_skeleton);
	if (state&&(field=(struct Computed_field *)field_void)&&
		(computed_field_spatial_skeleton_package=
		(struct Computed_field_spatial_skeleton_package *)
		computed_field_spatial_skeleton_package_void))
	{
		return_code=1;
		...
		set_source_field_data.computed_field_manager =
			computed_field_spatial_skeleton_package->computed_field_manager;
		...
		if (computed_field_spatial_skeleton_type_string ==
			Computed_field_get_type_string(field))
		{
			return_code = Computed_field_get_type_spatial_skeleton(field,
				&source_field, &texture_coordinate_field, &thinness,
		...
		if (return_code)
		{
			...
			if (return_code)
			{
				return_code = Computed_field_set_type_spatial_skeleton(field,
					source_field, texture_coordinate_field, thinness, dimension,
					sizes, minimums, maximums, element_dimension,
					computed_field_spatial_skeleton_package->computed_field_manager,
					computed_field_spatial_skeleton_package->root_region,
					computed_field_spatial_skeleton_package->graphics_buffer_package);
			}
			if (!return_code)
			{
						...
						strcmp(PARSER_RECURSIVE_HELP_STRING,state->current_token)))
				{
					/* error */
					display_message(ERROR_MESSAGE,
						"define_Computed_field_type_spatial_skeleton.  Failed");
				}
			}
			if (source_field)
			{
	...
	{
		display_message(ERROR_MESSAGE,
			"define_Computed_field_type_spatial_skeleton.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

	return (return_code);
} /* define_Computed_field_type_spatial_skeleton */
...
{
	int return_code;
	static struct Computed_field_spatial_skeleton_package
		computed_field_spatial_skeleton_package;

	ENTER(Computed_field_register_types_spatial_skeleton);
	if (computed_field_package)
	{
		computed_field_spatial_skeleton_package.computed_field_manager =
			Computed_field_package_get_computed_field_manager(
				computed_field_package);
		computed_field_spatial_skeleton_package.root_region = root_region;
		computed_field_spatial_skeleton_package.graphics_buffer_package = graphics_buffer_package;
		return_code = Computed_field_package_add_type(computed_field_package,
			            computed_field_spatial_skeleton_type_string,
			            define_Computed_field_type_spatial_skeleton,
			            &computed_field_spatial_skeleton_package);
	}
	else
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_register_types_spatial_skeleton.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

...
#define Computed_field_set_type_fast_marching_image_filter \
	Cmiss_computed_field_set_type_fast_marching_image_filter
#define Computed_field_get_type_fast_marching_image_filter \
	Cmiss_computed_field_get_type_fast_marching_image_filter
...
DESCRIPTION :
Converts <field> to type COMPUTED_FIELD_FAST_MARCHING_IMAGE_FILTER, returning the value of
<fast_marching_image_filter> at the time/parameter value given by scalar <source_field>.

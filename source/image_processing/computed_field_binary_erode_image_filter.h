...
#define Computed_field_set_type_binary_erode_image_filter \
	Cmiss_computed_field_set_type_binary_erode_image_filter
#define Computed_field_get_type_binary_erode_image_filter \
	Cmiss_computed_field_get_type_binary_erode_image_filter
...
Sets number of components to same number as <binary_erode_image_filter>.
==============================================================================*/

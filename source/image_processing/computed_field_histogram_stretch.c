...
int Computed_field_histogram_stretch_get_native_resolution(struct Computed_field *field,
...
{       
	...
	ENTER(Computed_field_histogram_stretch_get_native_resolution);
	if (field && (data =
		(struct Computed_field_histogram_stretch_type_specific_data *)
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_histogram_stretch_get_native_resolution.  Missing field");
		return_code=0;
	}

	return (return_code);
} /* Computed_field_histogram_stretch_get_native_resolution */

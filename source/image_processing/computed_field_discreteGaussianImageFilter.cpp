...
char computed_field_discrete_gaussian_image_filter_type_string[] = "discrete_gaussian__image_filter";
...
==============================================================================*/
{
		...
		Computed_field_is_scalar(source_field, (void *)NULL))
	{
			...
			number_of_source_fields))
		{
			...
			field->core = new Computed_field_discrete_gaussian_image_filter(field, variance, maxKernelWidth);
		}
		else
		{

...
int gradient_magnitude_recursive_gaussian(struct Computed_field *field,
  struct Computed_field **source_field, double *stopping_value, 
...
==============================================================================*/
{
	...
	ENTER(gradient_magnitude_recursive_gaussian);
	...
	{
		display_message(ERROR_MESSAGE,
			"gradient_magnitude_recursive_gaussian.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

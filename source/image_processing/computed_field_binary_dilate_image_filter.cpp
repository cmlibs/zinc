...
class Computed_field_binary_dilate_image_filter : public Computed_field_ImageFilter
{
...
public:
	...
	Computed_field_binary_dilate_image_filter(Computed_field *field,
...
private:
	...
	{
		return new Computed_field_binary_dilate_image_filter(new_parent,
			radius, dilate_value);
	}
...
public:
	...
	Computed_field_binary_dilate_image_filter_Functor(
		Computed_field_binary_dilate_image_filter *binary_dilate_image_filter) :
		Computed_field_ImageFilter_FunctorTmpl< ImageType >(binary_dilate_image_filter),
...
DESCRIPTION :
Converts <field> to type COMPUTED_FIELD_BINARYDILATEFILTER.
...
==============================================================================*/
{
	...
	ENTER(Computed_field_set_type_binary_dilate_image_filter);
		...
		Computed_field_is_scalar(source_field, (void *)NULL))
	{
			...
			number_of_source_fields))
		{
			...
			Computed_field_ImageFilter* filter_core = new Computed_field_binary_dilate_image_filter(field,
				radius, dilate_value);
			...
			{
				display_message(ERROR_MESSAGE,
					"Computed_field_set_type_binary_dilate_image_filter.  "
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_set_type_binary_dilate_image_filter.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;
...
==============================================================================*/
{
	...
	ENTER(Computed_field_get_type_binary_dilate_image_filter);
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_get_type_binary_dilate_image_filter.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

	return (return_code);
} /* Computed_field_get_type_binary_dilate_image_filter */
...
==============================================================================*/
{
		...
		(computed_field_simple_package = (Computed_field_simple_package*)computed_field_simple_package_void))
	{
		...
		radius = 1;
		dilate_value = 1;
		if (computed_field_binary_dilate_image_filter_type_string ==
			Computed_field_get_type_string(field))
		{
			return_code =
				Computed_field_get_type_binary_dilate_image_filter(field, &source_field,
					&radius, &dilate_value);
		}
		if (return_code)
		{
			...
			if (return_code)
			{
				return_code = Computed_field_set_type_binary_dilate_image_filter(
					field, source_field, radius, dilate_value);				
			}

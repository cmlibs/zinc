	...
	struct Computed_field *source_field, int radius, double dilate_value)
{
	...
	{
		display_message(ERROR_MESSAGE,
			"Cmiss_field_create_binary_dilate_image_filter.  Invalid argument(s)");
	}
...
==============================================================================*/
{
	...
	ENTER(Cmiss_field_get_type_binary_dilate_image_filter);
	...
	{
		display_message(ERROR_MESSAGE,
			"Cmiss_field_get_type_binary_dilate_image_filter.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

	return (return_code);
} /* Cmiss_field_get_type_binary_dilate_image_filter */
		...
		if (return_code)
		{
			...
			if (return_code)
			{
				return_code = field_modify->update_field_and_deaccess(
					Cmiss_field_create_binary_dilate_image_filter(

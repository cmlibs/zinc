...
static char computed_field_region_maximum_type_string[] = "region_maximum";

int Computed_field_is_type_region_maximum(struct Computed_field *field)
/*******************************************************************************
...
==============================================================================*/
{
	...
	ENTER(Computed_field_is_type_region_maximum);
	if (field)
	{
		return_code =
		  (field->type_string == computed_field_region_maximum_type_string);
	}
	else
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_is_type_region_maximum.  Missing field");
		return_code = 0;
	}

	return (return_code);
} /* Computed_field_is_type_region_maximum */

static void Computed_field_region_maximum_field_change(
...
==============================================================================*/
{
	...
	struct Computed_field_region_maximum_type_specific_data *data;

	ENTER(Computed_field_region_maximum_source_field_change);
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_region_maximum_source_field_change.  "
			"Invalid arguments.");
	}
	LEAVE;
} /* Computed_field_region_maximum_source_field_change */

static int Computed_field_region_maximum_clear_type_specific(
	struct Computed_field *field)
/*******************************************************************************
LAST MODIFIED : 6 January 2004
...
==============================================================================*/
{
	...
	ENTER(Computed_field_region_maximum_clear_type_specific);
	if (field && (data =
		(struct Computed_field_region_maximum_type_specific_data *)
		field->type_specific_data))
	{
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_region_maximum_clear_type_specific.  "
			"Invalid arguments.");
		return_code = 0;
	}
	LEAVE;
...
static void *Computed_field_region_maximum_copy_type_specific(
...
==============================================================================*/
{
	struct Computed_field_region_maximum_type_specific_data *destination,
		*source;

	ENTER(Computed_field_region_maximum_copy_type_specific);
	if (source_field && destination_field && (source =
		(struct Computed_field_region_maximum_type_specific_data *)
		source_field->type_specific_data))
	{
		if (ALLOCATE(destination,
			struct Computed_field_region_maximum_type_specific_data, 1))
		{
			...
			destination->computed_field_manager_callback_id =
				...
				Computed_field_region_maximum_field_change, (void *)destination_field,
		...
		{
			display_message(ERROR_MESSAGE,
				"Computed_field_region_maximum_copy_type_specific.  "
...
int Computed_field_region_maximum_clear_cache_type_specific
   (struct Computed_field *field)
/*******************************************************************************
LAST MODIFIED : 6 January 2004
...
==============================================================================*/
{
	...
	return (return_code);
} /* Computed_field_region_maximum_clear_cache_type_specific */

static int Computed_field_region_maximum_type_specific_contents_match(
...
==============================================================================*/
{
	...
	ENTER(Computed_field_region_maximum_type_specific_contents_match);
	...
	return (return_code);
} /* Computed_field_region_maximum_type_specific_contents_match */

#define Computed_field_region_maximum_is_defined_in_element \
...
#define Computed_field_region_maximum_is_defined_at_node \
...
#define Computed_field_region_maximum_has_numerical_components \
...
#define Computed_field_region_maximum_not_in_use \
...
static int Image_cache_region_maximum(struct Image_cache *image, int radius)
/*******************************************************************************
LAST MOErFIED : 24 August 2004

DESCRIPTION :
Find the local maximum points on the image cache.
==============================================================================*/
{
	char *storage;
	...
	if (image && (image->dimension > 0) && (image->depth > 0))
	{
		...
		{
			display_message(ERROR_MESSAGE,
				"Image_cache_region_maximum.  Not enough memory");
			return_code = 0;
		}
	}
	else
	{
		display_message(ERROR_MESSAGE, "Image_cache_region_maximum.  "
			"Invalid arguments.");
		return_code=0;
	}
	LEAVE;
	...
	return (return_code);
} /* Image_cache_region_maximum */

static int Computed_field_region_maximum_evaluate_cache_at_node(
...
==============================================================================*/
{
	...
	ENTER(Computed_field_region_maximum_evaluate_cache_at_node);
	if (field && node &&
		(data = (struct Computed_field_region_maximum_type_specific_data *)field->type_specific_data))
	{
		return_code = 1;
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_region_maximum_evaluate_cache_at_node.  "
			"Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;
...
static int Computed_field_region_maximum_evaluate_cache_in_element(
...
==============================================================================*/
{
	...
	ENTER(Computed_field_region_maximum_evaluate_cache_in_element);
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_region_maximum_evaluate_cache_in_element.  "
			"Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;
...
#define Computed_field_region_maximum_evaluate_as_string_at_node \
...
#define Computed_field_region_maximum_evaluate_as_string_in_element \
...
#define Computed_field_region_maximum_set_values_at_node \
...
#define Computed_field_region_maximum_set_values_in_element \
...
#define Computed_field_region_maximum_get_native_discretization_in_element \
...
#define Computed_field_region_maximum_find_element_xi \
...
{       
	...
	ENTER(Computed_field_region_maximum_get_native_resolution);
	if (field && (data =
		(struct Computed_field_region_maximum_type_specific_data *)
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_region_maximum_get_native_resolution.  Missing field");
		return_code=0;
	}

	return (return_code);
} /* Computed_field_region_maximum_get_native_resolution */

static int list_Computed_field_region_maximum(
	struct Computed_field *field)
/*******************************************************************************
...
==============================================================================*/
{
	...
	ENTER(List_Computed_field_region_maximum);
	if (field && (field->type_string==computed_field_region_maximum_type_string)
		&& (data = (struct Computed_field_region_maximum_type_specific_data *)
		field->type_specific_data))
	{
	...
	{
		display_message(ERROR_MESSAGE,
			"list_Computed_field_region_maximum.  Invalid field");
		return_code = 0;
	}
	LEAVE;

	return (return_code);
} /* list_Computed_field_region_maximum */

static char *Computed_field_region_maximum_get_command_string(
	struct Computed_field *field)
/*******************************************************************************
LAST MODIFIED : 4 December 2003
...
==============================================================================*/
{
	...
	ENTER(Computed_field_region_maximum_get_command_string);
		...
		field->type_specific_data) )
	{
		...
		append_string(&command_string,
			computed_field_region_maximum_type_string, &error);
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_region_maximum_get_command_string.  Invalid field");
	}
	LEAVE;

	return (command_string);
} /* Computed_field_region_maximum_get_command_string */

#define Computed_field_region_maximum_has_multiple_times \
...
==============================================================================*/
{
	...
	ENTER(Computed_field_set_type_region_maximum);
		...
		region && graphics_buffer_package)
	{
		...
		data = (struct Computed_field_region_maximum_type_specific_data *)NULL;
			...
			Image_cache_update_data_storage(data->image))
		{
			...
			data->computed_field_manager_callback_id =
				MANAGER_REGISTER(Computed_field)(
				Computed_field_region_maximum_field_change, (void *)field,
				computed_field_manager);

			field->type_specific_data = data;

			/* Set all the methods */
			COMPUTED_FIELD_ESTABLISH_METHODS(region_maximum);
		}
		else
		{
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_set_type_region_maximum.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

	return (return_code);
} /* Computed_field_set_type_region_maximum */
...
DESCRIPTION :
If the field is of type COMPUTED_FIELD_region_maximum, the
...
==============================================================================*/
{
	...
	ENTER(Computed_field_get_type_region_maximum);
	if (field && (field->type_string==computed_field_region_maximum_type_string)
		&& (data = (struct Computed_field_region_maximum_type_specific_data *)
		field->type_specific_data) && data->image)
	{
		*dimension = data->image->dimension;
		...
		{
			display_message(ERROR_MESSAGE,
				"Computed_field_get_type_region_maximum.  Unable to allocate vectors.");
			return_code = 0;
		}
	}
	else
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_get_type_region_maximum.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

	return (return_code);
} /* Computed_field_get_type_region_maximum */

static int define_Computed_field_type_region_maximum(struct Parse_state *state,
	void *field_void, void *computed_field_region_maximum_package_void)
/*******************************************************************************
LAST MODIFIED : 4 December 2003

DESCRIPTION :
Converts <field> into type COMPUTED_FIELD_region_maximum (if it is not
...
==============================================================================*/
{
	...
	ENTER(define_Computed_field_type_region_maximum);
	if (state&&(field=(struct Computed_field *)field_void)&&
		(computed_field_region_maximum_package=
		(struct Computed_field_region_maximum_package *)
		computed_field_region_maximum_package_void))
	{
		return_code=1;
		...
		if (computed_field_region_maximum_type_string ==
		...
		if (return_code)
		{
			...
			if (!return_code)
			{
						...
						strcmp(PARSER_RECURSIVE_HELP_STRING,state->current_token)))
				{
					/* error */
					display_message(ERROR_MESSAGE,
						"define_Computed_field_type_region_maximum.  Failed");
				}
			}
			if (source_field)
			{
	...
	{
		display_message(ERROR_MESSAGE,
			"define_Computed_field_type_region_maximum.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

	return (return_code);
} /* define_Computed_field_type_region_maximum */
...
{
	int return_code;
	static struct Computed_field_region_maximum_package
		computed_field_region_maximum_package;

	ENTER(Computed_field_register_types_region_maximum);
	if (computed_field_package)
	{
		computed_field_region_maximum_package.computed_field_manager =
			Computed_field_package_get_computed_field_manager(
				computed_field_package);
		computed_field_region_maximum_package.root_region = root_region;
		computed_field_region_maximum_package.graphics_buffer_package = graphics_buffer_package;
		return_code = Computed_field_package_add_type(computed_field_package,
			            computed_field_region_maximum_type_string,
			            define_Computed_field_type_region_maximum,
			            &computed_field_region_maximum_package);
	}
	else
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_register_types_region_maximum.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

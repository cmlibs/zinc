/******************************************************************
  FILE: computed_field_image_enhancement.c

  LAST MODIFIED: 27 February 2004

  DESCRIPTION:Implement image enhancement operation
==================================================================*/
#include <math.h>
...
struct Computed_field_image_enhancement_package
/*******************************************************************************
...
static char computed_field_image_enhancement_type_string[] = "image_enhancement";

int Computed_field_is_type_image_enhancement(struct Computed_field *field)
/*******************************************************************************
...
==============================================================================*/
{
	...
	ENTER(Computed_field_is_type_image_enhancement);
	if (field)
	{
		return_code =
		  (field->type_string == computed_field_image_enhancement_type_string);
	}
	else
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_is_type_image_enhancement.  Missing field");
		return_code = 0;
	}

	return (return_code);
} /* Computed_field_is_type_image_enhancement */

static void Computed_field_image_enhancement_field_change(
...
==============================================================================*/
{
	...
	ENTER(Computed_field_image_enhancement_source_field_change);
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_image_enhancement_source_field_change.  "
			"Invalid arguments.");
	}
	LEAVE;
} /* Computed_field_image_enhancement_source_field_change */

static int Computed_field_image_enhancement_clear_type_specific(
	struct Computed_field *field)
/*******************************************************************************
LAST MODIFIED : 6 January 2004
...
==============================================================================*/
{
	...
	ENTER(Computed_field_image_enhancement_clear_type_specific);
	if (field && (data =
		(struct Computed_field_image_enhancement_type_specific_data *)
		field->type_specific_data))
	{
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_image_enhancement_clear_type_specific.  "
			"Invalid arguments.");
		return_code = 0;
	}
	LEAVE;
...
static void *Computed_field_image_enhancement_copy_type_specific(
...
==============================================================================*/
{
	struct Computed_field_image_enhancement_type_specific_data *destination,
		*source;

	ENTER(Computed_field_image_enhancement_copy_type_specific);
	if (source_field && destination_field && (source =
		(struct Computed_field_image_enhancement_type_specific_data *)
		source_field->type_specific_data))
	{
		if (ALLOCATE(destination,
			struct Computed_field_image_enhancement_type_specific_data, 1))
		{
			destination->enhance_rate = source->enhance_rate;
			...
			destination->computed_field_manager_callback_id =
				...
				Computed_field_image_enhancement_field_change, (void *)destination_field,
		...
		{
			display_message(ERROR_MESSAGE,
				"Computed_field_image_enhancement_copy_type_specific.  "
...
int Computed_field_image_enhancement_clear_cache_type_specific
   (struct Computed_field *field)
/*******************************************************************************
LAST MODIFIED : 6 January 2004
...
static int Computed_field_image_enhancement_type_specific_contents_match(
...
==============================================================================*/
{
	...
	ENTER(Computed_field_image_enhancement_type_specific_contents_match);
	...
	{
		if ((data->enhance_rate == other_data->enhance_rate) &&
	...
	return (return_code);
} /* Computed_field_image_enhancement_type_specific_contents_match */

#define Computed_field_image_enhancement_is_defined_in_element \
...
#define Computed_field_image_enhancement_is_defined_at_node \
...
#define Computed_field_image_enhancement_has_numerical_components \
...
#define Computed_field_image_enhancement_not_in_use \
...
static int Image_cache_image_enhancement(struct Image_cache *image, double enhance_rate)
/*******************************************************************************
...
==============================================================================*/
{
	...
	ENTER(Image_cache_image_enhancement);
	if (image && (image->dimension > 0) && (image->depth > 0))
	{
		...
		{
			display_message(ERROR_MESSAGE,
				"Image_cache_image_enhancement.  Not enough memory");
			return_code = 0;
		}
	}
	else
	{
		display_message(ERROR_MESSAGE, "Image_cache_image_enhancement.  "
			"Invalid arguments.");
		return_code=0;
	}
	LEAVE;
	...
	return (return_code);
} /* Image_cache_image_enhancement */

static int Computed_field_image_enhancement_evaluate_cache_at_node(
...
==============================================================================*/
{
	...
	ENTER(Computed_field_image_enhancement_evaluate_cache_at_node);
	if (field && node &&
		(data = (struct Computed_field_image_enhancement_type_specific_data *)field->type_specific_data))
	{
		return_code = 1;
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_image_enhancement_evaluate_cache_at_node.  "
			"Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;
...
static int Computed_field_image_enhancement_evaluate_cache_in_element(
...
==============================================================================*/
{
	...
	ENTER(Computed_field_image_enhancement_evaluate_cache_in_element);
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_image_enhancement_evaluate_cache_in_element.  "
			"Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;
...
#define Computed_field_image_enhancement_evaluate_as_string_at_node \
...
#define Computed_field_image_enhancement_evaluate_as_string_in_element \
...
#define Computed_field_image_enhancement_set_values_at_node \
...
#define Computed_field_image_enhancement_set_values_in_element \
...
#define Computed_field_image_enhancement_get_native_discretization_in_element \
...
#define Computed_field_image_enhancement_find_element_xi \
...
int Computed_field_image_enhancement_get_native_resolution(struct Computed_field *field,
...
{       
	...
	ENTER(Computed_field_image_enhancement_get_native_resolution);
	if (field && (data =
		(struct Computed_field_image_enhancement_type_specific_data *)
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_image_enhancement_get_native_resolution.  Missing field");
		return_code=0;
	}

	return (return_code);
} /* Computed_field_image_enhancement_get_native_resolution */

static int list_Computed_field_image_enhancement(
	struct Computed_field *field)
/*******************************************************************************
...
==============================================================================*/
{
	...
	ENTER(List_Computed_field_image_enhancement);
	if (field && (field->type_string==computed_field_image_enhancement_type_string)
		&& (data = (struct Computed_field_image_enhancement_type_specific_data *)
		field->type_specific_data))
	{
		...
		display_message(INFORMATION_MESSAGE,
			"    filter enhance_rate : %f\n", data->enhance_rate);
		return_code = 1;
	}
	else
	{
		display_message(ERROR_MESSAGE,
			"list_Computed_field_image_enhancement.  Invalid field");
		return_code = 0;
	}
	LEAVE;

	return (return_code);
} /* list_Computed_field_image_enhancement */

static char *Computed_field_image_enhancement_get_command_string(
	struct Computed_field *field)
/*******************************************************************************
LAST MODIFIED : 4 December 2003
...
==============================================================================*/
{
	...
	ENTER(Computed_field_image_enhancement_get_command_string);
		...
		field->type_specific_data) )
	{
		...
		append_string(&command_string,
			computed_field_image_enhancement_type_string, &error);
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_image_enhancement_get_command_string.  Invalid field");
	}
	LEAVE;

	return (command_string);
} /* Computed_field_image_enhancement_get_command_string */

#define Computed_field_image_enhancement_has_multiple_times \
...
int Computed_field_set_type_image_enhancement(struct Computed_field *field,
...
DESCRIPTION :
Converts <field> to type COMPUTED_FIELD_image_enhancement with the supplied
fields, <source_field> and <texture_coordinate_field>.  The <enhance_rate> specifies
the enhanceing rate (> 1 sharpening, < 1 smoothing).  The <dimension> is the
...
==============================================================================*/
{
	...
	ENTER(Computed_field_set_type_image_enhancement);
		...
		region && graphics_buffer_package)
	{
		...
		data = (struct Computed_field_image_enhancement_type_specific_data *)NULL;
		if (ALLOCATE(source_fields, struct Computed_field *, number_of_source_fields) &&
			ALLOCATE(data, struct Computed_field_image_enhancement_type_specific_data, 1) &&
			...
			Image_cache_update_data_storage(data->image))
		{
			...
			data->computed_field_manager_callback_id =
				MANAGER_REGISTER(Computed_field)(
				Computed_field_image_enhancement_field_change, (void *)field,
				computed_field_manager);

			field->type_specific_data = data;

			/* Set all the methods */
			COMPUTED_FIELD_ESTABLISH_METHODS(image_enhancement);
		}
		else
		{
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_set_type_image_enhancement.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

	return (return_code);
} /* Computed_field_set_type_image_enhancement */

int Computed_field_get_type_image_enhancement(struct Computed_field *field,
	struct Computed_field **source_field,
	struct Computed_field **texture_coordinate_field,
	double *enhance_rate, int *dimension, int **sizes, FE_value **minimums,
	FE_value **maximums, int *element_dimension)
/*******************************************************************************
LAST MODIFIED : 17 December 2003

DESCRIPTION :
If the field is of type COMPUTED_FIELD_image_enhancement, the
...
==============================================================================*/
{
	...
	ENTER(Computed_field_get_type_image_enhancement);
	if (field && (field->type_string==computed_field_image_enhancement_type_string)
		&& (data = (struct Computed_field_image_enhancement_type_specific_data *)
		field->type_specific_data) && data->image)
	{
		*dimension = data->image->dimension;
			...
			&& ALLOCATE(*maximums, FE_value, *dimension))
		{
			...
			*enhance_rate = data->enhance_rate;
		...
		{
			display_message(ERROR_MESSAGE,
				"Computed_field_get_type_image_enhancement.  Unable to allocate vectors.");
			return_code = 0;
		}
	}
	else
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_get_type_image_enhancement.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

	return (return_code);
} /* Computed_field_get_type_image_enhancement */

static int define_Computed_field_type_image_enhancement(struct Parse_state *state,
	void *field_void, void *computed_field_image_enhancement_package_void)
/*******************************************************************************
LAST MODIFIED : 4 December 2003

DESCRIPTION :
Converts <field> into type COMPUTED_FIELD_image_enhancement (if it is not
...
==============================================================================*/
{
	...
	struct Computed_field_image_enhancement_package
		*computed_field_image_enhancement_package;
	struct Option_table *option_table;
	struct Set_Computed_field_conditional_data set_source_field_data,
		set_texture_coordinate_field_data;

	ENTER(define_Computed_field_type_image_enhancement);
	if (state&&(field=(struct Computed_field *)field_void)&&
		(computed_field_image_enhancement_package=
		(struct Computed_field_image_enhancement_package *)
		computed_field_image_enhancement_package_void))
	{
		return_code=1;
		...
		if (computed_field_image_enhancement_type_string ==
			Computed_field_get_type_string(field))
		{
			return_code = Computed_field_get_type_image_enhancement(field,
				&source_field, &texture_coordinate_field, &enhance_rate,
		...
		if (return_code)
		{
			...
			if (return_code)
			{
				return_code = Computed_field_set_type_image_enhancement(field,
					source_field, texture_coordinate_field, enhance_rate, dimension,
			...
			if (!return_code)
			{
						...
						strcmp(PARSER_RECURSIVE_HELP_STRING,state->current_token)))
				{
					/* error */
					display_message(ERROR_MESSAGE,
						"define_Computed_field_type_image_enhancement.  Failed");
				}
			}
			if (source_field)
			{
	...
	{
		display_message(ERROR_MESSAGE,
			"define_Computed_field_type_image_enhancement.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;
...
{
	int return_code;
	static struct Computed_field_image_enhancement_package
		computed_field_image_enhancement_package;

	ENTER(Computed_field_register_types_image_enhancement);
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_register_types_image_enhancement.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

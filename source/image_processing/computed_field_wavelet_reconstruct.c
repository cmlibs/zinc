/******************************************************************
  FILE: computed_field_wavelet_reconstruct.c

  LAST MODIFIED: 12 March 2004

  DESCRIPTION:Implement image wavelet reconstruct operation with db4
==================================================================*/
#include <math.h>
...
struct Computed_field_wavelet_reconstruct_package
/*******************************************************************************
...
struct Computed_field_wavelet_reconstruct_type_specific_data
{
	/* The number of reconstruction laters */
...
static char computed_field_wavelet_reconstruct_type_string[] = "wavelet_reconstruct";

int Computed_field_is_type_wavelet_reconstruct(struct Computed_field *field)
/*******************************************************************************
...
==============================================================================*/
{
	...
	ENTER(Computed_field_is_type_wavelet_reconstruct);
	if (field)
	{
		return_code =
		  (field->type_string == computed_field_wavelet_reconstruct_type_string);
	}
	else
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_is_type_wavelet_reconstruct.  Missing field");
		return_code = 0;
	}

	return (return_code);
} /* Computed_field_is_type_wavelet_reconstruct */

static void Computed_field_wavelet_reconstruct_field_change(
...
==============================================================================*/
{
	...
	struct Computed_field_wavelet_reconstruct_type_specific_data *data;

	ENTER(Computed_field_wavelet_reconstruct_source_field_change);
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_wavelet_reconstruct_source_field_change.  "
			"Invalid arguments.");
	}
	LEAVE;
} /* Computed_field_wavelet_reconstruct_source_field_change */

static int Computed_field_wavelet_reconstruct_clear_type_specific(
	struct Computed_field *field)
/*******************************************************************************
LAST MODIFIED : 10 December 2003
...
==============================================================================*/
{
	...
	ENTER(Computed_field_wavelet_reconstruct_clear_type_specific);
	if (field && (data =
		(struct Computed_field_wavelet_reconstruct_type_specific_data *)
		field->type_specific_data))
	{
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_wavelet_reconstruct_clear_type_specific.  "
			"Invalid arguments.");
		return_code = 0;
	}
	LEAVE;
...
static void *Computed_field_wavelet_reconstruct_copy_type_specific(
...
==============================================================================*/
{
	struct Computed_field_wavelet_reconstruct_type_specific_data *destination,
		*source;

	ENTER(Computed_field_wavelet_reconstruct_copy_type_specific);
	if (source_field && destination_field && (source =
		(struct Computed_field_wavelet_reconstruct_type_specific_data *)
		source_field->type_specific_data))
	{
		if (ALLOCATE(destination,
			struct Computed_field_wavelet_reconstruct_type_specific_data, 1))
		{
			...
			destination->computed_field_manager_callback_id =
				...
				Computed_field_wavelet_reconstruct_field_change, (void *)destination_field,
		...
		{
			display_message(ERROR_MESSAGE,
				"Computed_field_wavelet_reconstruct_copy_type_specific.  "
...
int Computed_field_wavelet_reconstruct_clear_cache_type_specific
   (struct Computed_field *field)
/*******************************************************************************
LAST MODIFIED : 10 December 2003
...
static int Computed_field_wavelet_reconstruct_type_specific_contents_match(
...
==============================================================================*/
{
	...
	ENTER(Computed_field_wavelet_reconstruct_type_specific_contents_match);
	...
	return (return_code);
} /* Computed_field_wavelet_reconstruct_type_specific_contents_match */

#define Computed_field_wavelet_reconstruct_is_defined_in_element \
...
#define Computed_field_wavelet_reconstruct_is_defined_at_node \
...
#define Computed_field_wavelet_reconstruct_has_numerical_components \
...
#define Computed_field_wavelet_reconstruct_not_in_use \
...
int Daubechies4_1D_inverse(FE_value *a, FE_value *wt_index, int n)
/**********************************************************************************
   LAST MODIFIED: 11 March 2004

   DESCRIPTION: Implemnet 1D wavelet reconstruction for each raw vector or column vector.
====================================================================================*/
{
        int nh1, i, j;
        int return_code;

        ENTER(Daubechies4_1D_inverse);
        ...
        if (n >= 4)
        {
	        ...
	        nh1 = n + 1;
                        ...
                        wt_index[0] = C2*a[n-1] + C1*a[n-1] + C0*a[0] + C3*a[nh1];
		        wt_index[1] = C3*a[n-1] - C0*a[n-1] + C1*a[0] - C2*a[nh1];
                        for (i = 0, j = 2; i < n-1; j += 2, i++)
		        {
                                  wt_index[j] = C2*a[i] + C1*a[i + nh1] + C0*a[i+1] + C3*a[i + n];
                                  wt_index[j+1] = C3*a[i] - C0*a[i + nh1] + C1*a[i+1] - C2*a[i + n];
                        }
        ...
        {
	        display_message(ERROR_MESSAGE,
			"Daubechies4_1D_inverse_forward.  "
			"Invalid arguments.");
		return_code = 0;
        }
	LEAVE;
	return(return_code);
}/* Daubechies4_1D_inverse */

int Image_cache_wavelet_reconstruct(struct Image_cache *image, int number_of_levels)
/*********************************************************************************
   LAST MODIFIED: 11 March 2004

   DESCRIPTION: Implement image wavelet reconstruction with Daubechies wavelet db4.
==================================================================================*/
{
	...
	int n, h, w;
	ENTER(Image_cache_wavelet_reconstruct);
        if (image)
	{
	         return_code = 1;
		 /* allocate storage */
			...
			for (pass = 0; pass < image->depth; pass++)
			{
                                ...
                                for (n = 0; n < number_of_levels; n++)
				{
					...
					/* inverse transform */
						         ...
						         Daubechies4_1D_inverse(wt_index, buf, h);
			        ...
			        /* transform along the X axis */
                                                 ...
                                                 for (j = 0; j < height; j++)
				                 {
                                        ...
                                        /* inverse transform */
	                                        ...
	                                        /* for(n = width; n >= 4; n /= 2) */
						          Daubechies4_1D_inverse(wt_index, buf, w);
	...
	LEAVE;
	return(return_code);;
}/* Image_cache_wavelet_reconstruct */


static int Computed_field_wavelet_reconstruct_evaluate_cache_at_node(
...
==============================================================================*/
{
	...
	ENTER(Computed_field_wavelet_reconstruct_evaluate_cache_at_node);
	if (field && node &&
		(data = (struct Computed_field_wavelet_reconstruct_type_specific_data *)field->type_specific_data))
	{
		return_code = 1;
		...
		if (!data->image->valid)
		{
			...
			return_code = Image_cache_wavelet_reconstruct(data->image, data->number_of_levels);
		}
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_wavelet_reconstruct_evaluate_cache_at_node.  "
			"Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;
...
static int Computed_field_wavelet_reconstruct_evaluate_cache_in_element(
...
==============================================================================*/
{
	...
	ENTER(Computed_field_wavelet_reconstruct_evaluate_cache_in_element);
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_wavelet_reconstruct_evaluate_cache_in_element.  "
			"Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;
...
#define Computed_field_wavelet_reconstruct_evaluate_as_string_at_node \
...
#define Computed_field_wavelet_reconstruct_evaluate_as_string_in_element \
...
#define Computed_field_wavelet_reconstruct_set_values_at_node \
...
#define Computed_field_wavelet_reconstruct_set_values_in_element \
...
#define Computed_field_wavelet_reconstruct_get_native_discretization_in_element \
...
#define Computed_field_wavelet_reconstruct_find_element_xi \
...
int Computed_field_wavelet_reconstruct_get_native_resolution(struct Computed_field *field,
...
{       
	...
	ENTER(Computed_field_wavelet_reconstruct_get_native_resolution);
	if (field && (data =
		(struct Computed_field_wavelet_reconstruct_type_specific_data *)
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_wavelet_reconstruct_get_native_resolution.  Missing field");
		return_code=0;
	}

	return (return_code);
} /* Computed_field_wavelet_reconstruct_get_native_resolution */

static int list_Computed_field_wavelet_reconstruct(
	struct Computed_field *field)
/*******************************************************************************
...
==============================================================================*/
{
	...
	ENTER(List_Computed_field_wavelet_reconstruct);
	if (field && (field->type_string==computed_field_wavelet_reconstruct_type_string)
		&& (data = (struct Computed_field_wavelet_reconstruct_type_specific_data *)
		field->type_specific_data))
	{
	...
	{
		display_message(ERROR_MESSAGE,
			"list_Computed_field_wavelet_reconstruct.  Invalid field");
		return_code = 0;
	}
	LEAVE;

	return (return_code);
} /* list_Computed_field_wavelet_reconstruct */

static char *Computed_field_wavelet_reconstruct_get_command_string(
	struct Computed_field *field)
/*******************************************************************************
LAST MODIFIED : 4 December 2003
...
==============================================================================*/
{
	...
	ENTER(Computed_field_wavelet_reconstruct_get_command_string);
		...
		field->type_specific_data) )
	{
		...
		append_string(&command_string,
			computed_field_wavelet_reconstruct_type_string, &error);
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_wavelet_reconstruct_get_command_string.  Invalid field");
	}
	LEAVE;

	return (command_string);
} /* Computed_field_wavelet_reconstruct_get_command_string */

#define Computed_field_wavelet_reconstruct_has_multiple_times \
...
int Computed_field_set_type_wavelet_reconstruct(struct Computed_field *field,
...
DESCRIPTION :
Converts <field> to type COMPUTED_FIELD_wavelet_reconstruct with the supplied
...
==============================================================================*/
{
	...
	ENTER(Computed_field_set_type_wavelet_reconstruct);
		...
		region && graphics_buffer_package)
	{
		...
		data = (struct Computed_field_wavelet_reconstruct_type_specific_data *)NULL;
		if (ALLOCATE(source_fields, struct Computed_field *, number_of_source_fields) &&
			ALLOCATE(data, struct Computed_field_wavelet_reconstruct_type_specific_data, 1) &&
			...
			Image_cache_update_data_storage(data->image))
		{
			...
			data->computed_field_manager_callback_id =
				MANAGER_REGISTER(Computed_field)(
				Computed_field_wavelet_reconstruct_field_change, (void *)field,
				computed_field_manager);

			field->type_specific_data = data;

			/* Set all the methods */
			COMPUTED_FIELD_ESTABLISH_METHODS(wavelet_reconstruct);
		}
		else
		{
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_set_type_wavelet_reconstruct.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

	return (return_code);
} /* Computed_field_set_type_wavelet_reconstruct */

int Computed_field_get_type_wavelet_reconstruct(struct Computed_field *field,
	struct Computed_field **source_field,
	struct Computed_field **texture_coordinate_field,
...
DESCRIPTION :
If the field is of type COMPUTED_FIELD_wavelet_reconstruct, the
...
==============================================================================*/
{
	...
	ENTER(Computed_field_get_type_wavelet_reconstruct);
	if (field && (field->type_string==computed_field_wavelet_reconstruct_type_string)
		&& (data = (struct Computed_field_wavelet_reconstruct_type_specific_data *)
		field->type_specific_data) && data->image)
	{
		*dimension = data->image->dimension;
		...
		{
			display_message(ERROR_MESSAGE,
				"Computed_field_get_type_wavelet_reconstruct.  Unable to allocate vectors.");
			return_code = 0;
		}
	}
	else
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_get_type_wavelet_reconstruct.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

	return (return_code);
} /* Computed_field_get_type_wavelet_reconstruct */

static int define_Computed_field_type_wavelet_reconstruct(struct Parse_state *state,
	void *field_void, void *computed_field_wavelet_reconstruct_package_void)
/*******************************************************************************
LAST MODIFIED : 4 December 2003

DESCRIPTION :
Converts <field> into type COMPUTED_FIELD_wavelet_reconstruct (if it is not
...
==============================================================================*/
{
	...
	struct Computed_field_wavelet_reconstruct_package
		*computed_field_wavelet_reconstruct_package;
	struct Option_table *option_table;
	struct Set_Computed_field_conditional_data set_source_field_data,
		set_texture_coordinate_field_data;

	ENTER(define_Computed_field_type_wavelet_reconstruct);
	if (state&&(field=(struct Computed_field *)field_void)&&
		(computed_field_wavelet_reconstruct_package=
		(struct Computed_field_wavelet_reconstruct_package *)
		computed_field_wavelet_reconstruct_package_void))
	{
		return_code=1;
		...
		set_source_field_data.computed_field_manager =
			computed_field_wavelet_reconstruct_package->computed_field_manager;
		...
		if (computed_field_wavelet_reconstruct_type_string ==
			Computed_field_get_type_string(field))
		{
			return_code = Computed_field_get_type_wavelet_reconstruct(field,
		...
		if (return_code)
		{
			...
			if (return_code)
			{
				return_code = Computed_field_set_type_wavelet_reconstruct(field,
					source_field, texture_coordinate_field, number_of_levels, dimension,
					sizes, minimums, maximums, element_dimension,
					computed_field_wavelet_reconstruct_package->computed_field_manager,
					computed_field_wavelet_reconstruct_package->root_region,
					computed_field_wavelet_reconstruct_package->graphics_buffer_package);
			}
			if (!return_code)
			{
						...
						strcmp(PARSER_RECURSIVE_HELP_STRING,state->current_token)))
				{
					/* error */
					display_message(ERROR_MESSAGE,
						"define_Computed_field_type_wavelet_reconstruct.  Failed");
				}
			}
			if (source_field)
			{
	...
	{
		display_message(ERROR_MESSAGE,
			"define_Computed_field_type_wavelet_reconstruct.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

	return (return_code);
} /* define_Computed_field_type_wavelet_reconstruct */
...
{
	int return_code;
	static struct Computed_field_wavelet_reconstruct_package
		computed_field_wavelet_reconstruct_package;

	ENTER(Computed_field_register_types_wavelet_reconstruct);
	if (computed_field_package)
	{
		computed_field_wavelet_reconstruct_package.computed_field_manager =
			Computed_field_package_get_computed_field_manager(
				computed_field_package);
		computed_field_wavelet_reconstruct_package.root_region = root_region;
		computed_field_wavelet_reconstruct_package.graphics_buffer_package = graphics_buffer_package;
		return_code = Computed_field_package_add_type(computed_field_package,
			            computed_field_wavelet_reconstruct_type_string,
			            define_Computed_field_type_wavelet_reconstruct,
			            &computed_field_wavelet_reconstruct_package);
	}
	else
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_register_types_wavelet_reconstruct.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

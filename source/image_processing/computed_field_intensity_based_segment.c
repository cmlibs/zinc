...
/******************************************************************
  FILE : computed_field_intensity_based_segment.c
...
struct Computed_field_intensity_based_segment_package
/*******************************************************************************
...
struct Computed_field_intensity_based_segment_type_specific_data
{
...
static char computed_field_intensity_based_segment_type_string[] = "intensity_based_segment";

int Computed_field_is_type_intensity_based_segment(struct Computed_field *field)
/*******************************************************************************
...
==============================================================================*/
{
	...
	ENTER(Computed_field_is_type_intensity_based_segment);
	if (field)
	{
		return_code =
		  (field->type_string == computed_field_intensity_based_segment_type_string);
	}
	else
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_is_type_intensity_based_segment.  Missing field");
		return_code = 0;
	}

	return (return_code);
} /* Computed_field_is_type_intensity_based_segment */

static void Computed_field_intensity_based_segment_field_change(
...
==============================================================================*/
{
	...
	ENTER(Computed_field_intensity_based_segment_source_field_change);
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_intensity_based_segment_source_field_change.  "
			"Invalid arguments.");
	}
	LEAVE;
} /* Computed_field_intensity_based_segment_source_field_change */

static int Computed_field_intensity_based_segment_clear_type_specific(
	struct Computed_field *field)
/*******************************************************************************
LAST MODIFIED : 18 December 2003
...
==============================================================================*/
{
	...
	ENTER(Computed_field_intensity_based_segment_clear_type_specific);
	if (field && (data =
		(struct Computed_field_intensity_based_segment_type_specific_data *)
		field->type_specific_data))
	{
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_intensity_based_segment_clear_type_specific.  "
			"Invalid arguments.");
		return_code = 0;
	}
	LEAVE;
...
static void *Computed_field_intensity_based_segment_copy_type_specific(
...
==============================================================================*/
{
	struct Computed_field_intensity_based_segment_type_specific_data *destination,
		*source;

	ENTER(Computed_field_intensity_based_segment_copy_type_specific);
	if (source_field && destination_field && (source =
		(struct Computed_field_intensity_based_segment_type_specific_data *)
		source_field->type_specific_data))
	{
		if (ALLOCATE(destination,
			struct Computed_field_intensity_based_segment_type_specific_data, 1))
		{
			...
			destination->computed_field_manager_callback_id =
				...
				Computed_field_intensity_based_segment_field_change, (void *)destination_field,
		...
		{
			display_message(ERROR_MESSAGE,
				"Computed_field_intensity_based_segment_copy_type_specific.  "
...
int Computed_field_intensity_based_segment_clear_cache_type_specific
   (struct Computed_field *field)
/*******************************************************************************
LAST MODIFIED : 18 December 2003
...
static int Computed_field_intensity_based_segment_type_specific_contents_match(
...
==============================================================================*/
{
	...
	ENTER(Computed_field_intensity_based_segment_type_specific_contents_match);
	...
	return (return_code);
} /* Computed_field_intensity_based_segment_type_specific_contents_match */

#define Computed_field_intensity_based_segment_is_defined_in_element \
...
#define Computed_field_intensity_based_segment_is_defined_at_node \
...
#define Computed_field_intensity_based_segment_has_numerical_components \
...
#define Computed_field_intensity_based_segment_not_in_use \
...
static int Image_cache_intensity_based_segment(struct Image_cache *image)
/*******************************************************************************
LAST MODIFIED : 18 December 2003
...
==============================================================================*/
{
	...
	return (return_code);
} /* Image_cache_intensity_based_segment */


static int Computed_field_intensity_based_segment_evaluate_cache_at_node(
...
==============================================================================*/
{
	...
	ENTER(Computed_field_intensity_based_segment_evaluate_cache_at_node);
	if (field && node &&
		(data = (struct Computed_field_intensity_based_segment_type_specific_data *)field->type_specific_data))
	{
		return_code = 1;
		...
		if (!data->image->valid)
		{
			...
			return_code = Image_cache_intensity_based_segment(data->image);
		}
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_intensity_based_segment_evaluate_cache_at_node.  "
			"Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;
...
static int Computed_field_intensity_based_segment_evaluate_cache_in_element(
...
==============================================================================*/
{
	...
	ENTER(Computed_field_intensity_based_segment_evaluate_cache_in_element);
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_intensity_based_segment_evaluate_cache_in_element.  "
			"Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;
...
#define Computed_field_intensity_based_segment_evaluate_as_string_at_node \
...
#define Computed_field_intensity_based_segment_evaluate_as_string_in_element \
...
#define Computed_field_intensity_based_segment_set_values_at_node \
...
#define Computed_field_intensity_based_segment_set_values_in_element \
...
#define Computed_field_intensity_based_segment_get_native_discretization_in_element \
...
#define Computed_field_intensity_based_segment_find_element_xi \
...
static int list_Computed_field_intensity_based_segment(
	struct Computed_field *field)
/*******************************************************************************
...
==============================================================================*/
{
	...
	ENTER(List_Computed_field_intensity_based_segment);
	if (field)
	{
	...
	{
		display_message(ERROR_MESSAGE,
			"list_Computed_field_intensity_based_segment.  Invalid field");
		return_code = 0;
	}
	LEAVE;

	return (return_code);
} /* list_Computed_field_intensity_based_segment */

static char *Computed_field_intensity_based_segment_get_command_string(
	struct Computed_field *field)
/*******************************************************************************
LAST MODIFIED : 4 December 2003
...
==============================================================================*/
{
	...
	if (field)
	{
		...
		append_string(&command_string,
			computed_field_intensity_based_segment_type_string, &error);
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_intensity_based_segment_get_command_string.  Invalid field");
	}
	LEAVE;

	return (command_string);
} /* Computed_field_intensity_based_segment_get_command_string */

#define Computed_field_intensity_based_segment_has_multiple_times \
...
int Computed_field_set_type_intensity_based_segment(struct Computed_field *field,
...
DESCRIPTION :
Converts <field> to type COMPUTED_FIELD_intensity_based_segment with the supplied
...
==============================================================================*/
{
	...
	ENTER(Computed_field_set_type_intensity_based_segment);
		...
		region && user_interface)
	{
		...
		data = (struct Computed_field_intensity_based_segment_type_specific_data *)NULL;
		if (ALLOCATE(source_fields, struct Computed_field *, number_of_source_fields) &&
			ALLOCATE(data, struct Computed_field_intensity_based_segment_type_specific_data, 1) &&
			...
			Image_cache_update_data_storage(data->image))
		{
			...
			data->computed_field_manager_callback_id =
				MANAGER_REGISTER(Computed_field)(
				Computed_field_intensity_based_segment_field_change, (void *)field,
				computed_field_manager);

			field->type_specific_data = data;

			/* Set all the methods */
			COMPUTED_FIELD_ESTABLISH_METHODS(intensity_based_segment);
		}
		else
		{
	...
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_set_type_intensity_based_segment.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

	return (return_code);
} /* Computed_field_set_type_intensity_based_segment */

int Computed_field_get_type_intensity_based_segment(struct Computed_field *field,
	struct Computed_field **source_field,
	struct Computed_field **texture_coordinate_field,
	int *dimension, int **sizes, FE_value **minimums, FE_value **maximums,
	int *element_dimension)
...
DESCRIPTION :
If the field is of type COMPUTED_FIELD_intensity_based_segment, the
...
==============================================================================*/
{
	...
	ENTER(Computed_field_get_type_intensity_based_segment);
	if (field && (field->type_string==computed_field_intensity_based_segment_type_string)
		&& (data = (struct Computed_field_intensity_based_segment_type_specific_data *)
		field->type_specific_data) && data->image)
	{
		*dimension = data->image->dimension;
		...
		{
			display_message(ERROR_MESSAGE,
				"Computed_field_get_type_intensity_based_segment.  Unable to allocate vectors.");
			return_code = 0;
		}
	}
	else
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_get_type_intensity_based_segment.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

	return (return_code);
} /* Computed_field_get_type_intensity_based_segment */

static int define_Computed_field_type_intensity_based_segment(struct Parse_state *state,
	void *field_void, void *computed_field_intensity_based_segment_package_void)
/*******************************************************************************
LAST MODIFIED : 4 December 2003

DESCRIPTION :
Converts <field> into type COMPUTED_FIELD_intensity_based_segment (if it is not
...
==============================================================================*/
{
	...
	struct Computed_field_intensity_based_segment_package
		*computed_field_intensity_based_segment_package;
	struct Option_table *option_table;
	struct Set_Computed_field_conditional_data set_source_field_data,
		set_texture_coordinate_field_data;

	ENTER(define_Computed_field_type_intensity_based_segment);
	if (state&&(field=(struct Computed_field *)field_void)&&
		(computed_field_intensity_based_segment_package=
		(struct Computed_field_intensity_based_segment_package *)
		computed_field_intensity_based_segment_package_void))
	{
		return_code=1;
		...
		set_source_field_data.computed_field_manager =
			computed_field_intensity_based_segment_package->computed_field_manager;
		...
		if (computed_field_intensity_based_segment_type_string ==
			Computed_field_get_type_string(field))
		{
			return_code = Computed_field_get_type_intensity_based_segment(field,
		...
		if (return_code)
		{
			...
			if (return_code)
			{
				return_code = Computed_field_set_type_intensity_based_segment(field,
					source_field, texture_coordinate_field, dimension,
					sizes, minimums, maximums, element_dimension,
					computed_field_intensity_based_segment_package->computed_field_manager,
					computed_field_intensity_based_segment_package->root_region,
					computed_field_intensity_based_segment_package->user_interface);
			}
			if (!return_code)
			{
						...
						strcmp(PARSER_RECURSIVE_HELP_STRING,state->current_token)))
				{
					/* error */
					display_message(ERROR_MESSAGE,
						"define_Computed_field_type_intensity_based_segment.  Failed");
				}
			}
			if (source_field)
			{
	...
	{
		display_message(ERROR_MESSAGE,
			"define_Computed_field_type_intensity_based_segment.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

	return (return_code);
} /* define_Computed_field_type_intensity_based_segment */
...
{
	int return_code;
	static struct Computed_field_intensity_based_segment_package
		computed_field_intensity_based_segment_package;

	ENTER(Computed_field_register_types_intensity_based_segment);
	if (computed_field_package)
	{
		computed_field_intensity_based_segment_package.computed_field_manager =
			Computed_field_package_get_computed_field_manager(
				computed_field_package);
		computed_field_intensity_based_segment_package.root_region = root_region;
		computed_field_intensity_based_segment_package.user_interface = user_interface;
		return_code = Computed_field_package_add_type(computed_field_package,
			            computed_field_intensity_based_segment_type_string,
			            define_Computed_field_type_intensity_based_segment,
			            &computed_field_intensity_based_segment_package);
	}
	else
	{
		display_message(ERROR_MESSAGE,
			"Computed_field_register_types_intensity_based_segment.  Invalid argument(s)");
		return_code = 0;
	}
	LEAVE;

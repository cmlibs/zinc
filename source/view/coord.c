...
DECLARE_FIND_BY_IDENTIFIER_IN_LIST_FUNCTION(Cmgui_coordinate,name,const char *,strcmp)
...
==============================================================================*/
{
	...
	if (MrmOpenHierarchy_binary_string(coord_uidh,sizeof(coord_uidh),

...
PROTOTYPE_FIND_BY_IDENTIFIER_IN_LIST_FUNCTION(GROUP(object_type),name,const char *); \
PROTOTYPE_MANAGER_FUNCTIONS(GROUP(object_type)); \
PROTOTYPE_MANAGER_IDENTIFIER_FUNCTIONS(GROUP(object_type),name,const char *); \
PROTOTYPE_MANAGER_COPY_FUNCTIONS(GROUP(object_type),name,const char *)

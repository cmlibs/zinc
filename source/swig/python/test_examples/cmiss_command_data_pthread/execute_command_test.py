#*******************************************************************************
#FILE : execute_command_test.py

#LAST MODIFIED : 18 December 2008

#DESCRIPTION :
#python script for testing execute_command wrapped functions
#===============================================================================
# * ***** BEGIN LICENSE BLOCK *****
...
region_1_id = execute_command.Cmiss_region_get_sub_region(root_region_id, region)
...
#==========================================================================#
field = "coordinates"
field_1_id=execute_command.Cmiss_region_find_field_by_name(region_1_id, field)
...
node_1_fieldvalues = execute_command.new_float_array(array_size) # carrays method
execute_command.Cmiss_field_evaluate_at_node(field_1_id, node_1_id, 0, array_size, node_1_fieldvalues)

for i in range(0,array_size):
    field_values[i]=execute_command.float_array_getitem(node_1_fieldvalues,i) #carrays method

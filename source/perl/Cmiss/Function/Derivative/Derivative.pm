package Cmiss::Function::Derivative;
...
# This allows declaration	use Cmiss::Function::Derivative ':all';
...
sub AUTOLOAD {
    ...
    croak "&Cmiss::Function::Derivative::constant not defined" if $constname eq 'constant';
...
require XSLoader;
XSLoader::load('Cmiss::Function::Derivative', $VERSION);
...
Cmiss::Function::Derivative - Perl extension for Cmiss derivative functions
...
=head1 ABSTRACT
  ...
  This should be the abstract for Cmiss::Function::Derivative.
...
Stub documentation for Cmiss::Function::Derivative, created by h2xs. It looks like

package Cmiss::Function::Element;
...
# This allows declaration	use Cmiss::Function::Element ':all';
...
sub AUTOLOAD {
    ...
    croak "&Cmiss::Function::Element::constant not defined" if $constname eq 'constant';
...
require XSLoader;
XSLoader::load('Cmiss::Function::Element', $VERSION);
...
Cmiss::Function::Element - Perl extension for Cmiss element/xi functions
...
=head1 ABSTRACT
  ...
  This should be the abstract for Cmiss::Function::Element.
...
Stub documentation for Cmiss::Function::Element, created by h2xs. It looks like

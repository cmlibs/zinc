package Cmiss::Function::Gradient;
...
# This allows declaration	use Cmiss::Function::Gradient ':all';
...
sub AUTOLOAD {
    ...
    croak "&Cmiss::Function::Gradient::constant not defined" if $constname eq 'constant';
...
require XSLoader;
XSLoader::load('Cmiss::Function::Gradient', $VERSION);
...
Cmiss::Function::Gradient - Perl extension for Cmiss gradient functions
...
=head1 ABSTRACT
  ...
  This should be the abstract for Cmiss::Function::Gradient.
...
Stub documentation for Cmiss::Function::Gradient, created by h2xs. It looks like

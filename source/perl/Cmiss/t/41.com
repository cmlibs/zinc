...
# testing Cmiss::Function::Matrix::Product
...
$function_4=new Cmiss::Function::Matrix::Product($variable_1,$variable_2);
$variable_4=$function_4->output();
print "$function_4 $variable_4\n";
# mismatched multiplier and multiplicand
$function_4a=new Cmiss::Function::Matrix::Product($variable_1,$variable_3);
...
$function_5=new Cmiss::Function::Matrix::Product($variable_3,$variable_4);
$variable_5=$function_5->output();
print "$function_5 $variable_5\n";
print "\n";

# get value without evaluating
$function_6=$function_5->sub_matrix(row_low=>1,row_high=>2,column_low=>1,column_high=>2);
print "$function_6\n";
print "\n";
...
# get value without evaluating
$function_9=$function_5->sub_matrix(row_low=>1,row_high=>2,column_low=>1,column_high=>2);
print "$function_9\n";
print "\n";
...
# check sub-matrix
$function_12=$function_5->sub_matrix(row_low=>1,row_high=>2,column_low=>2,column_high=>2);
print "$function_12\n";
print "\n";

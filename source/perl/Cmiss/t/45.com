...
# testing Cmiss::Function::Matrix::Resize
...
$function_2=new Cmiss::Function::Matrix::Resize(variable=>$variable_1,n_columns=>1);
...
$function_4=new Cmiss::Function::Matrix::Resize(variable=>$variable_3,n_columns=>3);
...
print "$function_5\n";
$function_5a=$variable_4->evaluate();
print "$function_5a\n";
print "\n";

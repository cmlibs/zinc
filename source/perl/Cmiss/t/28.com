...
# testing Cmiss::Function_variable::Composite
...
print "$function_3\n";
$function_4=$variable_1->evaluate_derivative(independent=>[new Cmiss::Function_variable::Composite($function_2->output(),$function_1->output())]);
print "$function_4\n";

...
# testing Cmiss::Function_variable::Exclusion
...
$variable_1=new Cmiss::Function_variable::Exclusion($function_1->output(),$function_2->output());
...
print "$function_3\n";
$function_4=$variable_1->evaluate_derivative(independent=>[new Cmiss::Function_variable::Exclusion($function_2->output(),$function_1->output())]);
print "$function_4\n";
...
# check entry
$variable_2=new Cmiss::Function_variable::Exclusion($function_1->column(1),$function_1->entry(2,1));

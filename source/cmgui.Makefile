...
ifeq ($(SYSNAME),win32)
   ...
   SO_LIB_FINITE_ELEMENT_EXTRA_ARGS = $(BIN_PATH)/$(SO_LIB_GENERAL_TARGET) $(XML2_LIB)
...
$(SO_LIB_COMPUTED_VARIABLE_TARGET) : $(LIB_COMPUTED_VARIABLE_OBJS) $(SO_LIB_GENERAL_TARGET) cmgui.Makefile
	$(call BuildSharedLibraryTarget,$(SO_LIB_COMPUTED_VARIABLE_TARGET),$(BIN_PATH),$(LIB_COMPUTED_VARIABLE_OBJS),$(ALL_SO_LINK_FLAGS) $(SO_LIB_COMPUTED_VARIABLE_EXTRA_ARGS) $(SOLIB_LIB),$(SO_LIB_COMPUTED_VARIABLE_SONAME),$(BIN_PATH)/$(SO_LIB_GENERAL_IMPORT))
...
$(SO_LIB_TARGET) : $(REMAINING_LIB_OBJS) $(COMPILED_RESOURCE_FILES) $(OBJECT_PATH)/$(EXPORTS_FILE) $(SO_LIB_COMPUTED_VARIABLE_TARGET) $(SO_LIB_FINITE_ELEMENT_TARGET) $(SO_LIB_COMPUTED_VARIABLE_FINITE_ELEMENT_TARGET) $(SO_LIB_GENERAL_TARGET) cmgui.Makefile
	$(call BuildSharedLibraryTarget,$(SO_LIB_TARGET),$(BIN_PATH),$(REMAINING_LIB_OBJS),$(SO_ALL_LIB) $(COMPILED_RESOURCE_FILES) ,$(SO_LIB_SONAME),$(BIN_PATH)/$(SO_LIB_COMPUTED_VARIABLE_FINITE_ELEMENT_IMPORT) $(BIN_PATH)/$(SO_LIB_COMPUTED_VARIABLE_IMPORT) $(BIN_PATH)/$(SO_LIB_FINITE_ELEMENT_IMPORT) $(BIN_PATH)/$(SO_LIB_GENERAL_IMPORT))

...
LIB_GENERAL_SRCS = \
	...
	general/value.c \
	user_interface/message.c
LIB_GENERAL_OBJS = $(patsubst %,%.o,$(basename $(LIB_GENERAL_SRCS)))
...
LIB_COMPUTED_VARIABLE_SRCS = \
	...
	$(MATRIX_SRCS)
LIB_COMPUTED_VARIABLE_OBJS = $(patsubst %,%.o,$(basename $(LIB_COMPUTED_VARIABLE_SRCS)))
...
LIB_COMPUTED_VARIABLE_FINITE_ELEMENT_OBJS = $(patsubst %,%.o,$(basename $(LIB_COMPUTED_VARIABLE_FINITE_ELEMENT_SRCS)))
...
REMAINING_LIB_OBJS = $(patsubst %,%.o,$(basename $(REMAINING_LIB_SRCS)))

...
if (NOT WIN32)
  ...
  # -orig- include(UsePkgConfig)
	include( FindPkgConfig )

	pkg_search_module( libpcre _PCREIncDir )
	pkg_search_module( libpcre _PCRELinkDir )
	#pkg_search_module( libpcre _PCRELinkFlags )
	#pkg_search_module( libpcre _PCRECflags )
  # -orig- pkgconfig(libpcre _PCREIncDir _PCRELinkDir _PCRELinkFlags _PCRECflags)
endif (NOT WIN32)

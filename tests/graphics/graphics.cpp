...
TEST(cmzn_graphics, point_description_io)
{
	...
	char *descriptionString = readFileToString(TestResources::getLocation(TestResources::GRAPHICS_POINTS_DESCRIPTION_JSON_RESOURCE));
	...
	descriptionString = zinc.scene.writeDescription();
	EXPECT_NE(nullptr, descriptionString);

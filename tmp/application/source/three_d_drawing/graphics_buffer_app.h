...
PROTOTYPE_OBJECT_FUNCTIONS(Graphics_buffer_app);
...
Graphics_buffer_app *create_Graphics_buffer_offscreen(
...
struct Graphics_buffer_app *create_Graphics_buffer_shared_offscreen(
	struct Graphics_buffer_app_package *graphics_buffer_package,
	int width, int height,
	enum Graphics_buffer_buffering_mode buffering_mode,
	enum Graphics_buffer_stereo_mode stereo_mode,
...
struct Graphics_buffer_app *create_Graphics_buffer_offscreen_from_buffer(int width, int height, struct Graphics_buffer_app *buffer_to_match);
/*******************************************************************************
LAST MODIFIED : 6 May 2004
...
struct Graphics_buffer_app *create_Graphics_buffer_wx(struct Graphics_buffer_app_package *graphics_buffer_package,
	wxPanel *parent,
	enum Graphics_buffer_buffering_mode buffering_mode,
	enum Graphics_buffer_stereo_mode stereo_mode,
	int minimum_colour_buffer_depth, int minimum_depth_buffer_depth,
	int minimum_accumulation_buffer_depth,
	Graphics_buffer_app *buffer_to_match);
/*******************************************************************************
...
int DESTROY(Graphics_buffer_app)(struct Graphics_buffer_app **buffer);
/*******************************************************************************
LAST MODIFIED : 1 July 2002

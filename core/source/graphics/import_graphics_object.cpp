						...
						switch (object_type)
						{
							case g_POINT:
							{
								...
								point = CREATE(GT_point)(pointlist,(char *)NULL,
									...
									/*object_name*/0,(GLfloat *)NULL, (struct Cmiss_graphics_font *)NULL);
							...
							case g_POINTSET:
							{
								...
								pointset = CREATE(GT_pointset)(npts1,pointlist,
									...
									(GLfloat *)NULL,(int *)NULL, (struct Cmiss_graphics_font *)NULL);
						...
						else if (0==strcmp(word,"usemtl"))
						{
							...
							if (word)
							{
										...
										fuzzy_string_compare_same_length(matname,"NONE")))
								{
									...
									{
										Cmiss_graphics_material_set_attribute_integer(scanned_material, CMISS_GRAPHICS_MATERIAL_ATTRIBUTE_IS_MANAGED, 1);
									}
									else
									{
										scanned_material = (struct Graphical_material *)NULL;

...
class Computed_field_curvature_anisotropic_diffusion_image_filter : public computed_field_image_filter
{
...
private:
	...
	{
		return new Computed_field_curvature_anisotropic_diffusion_image_filter(field->source_fields[0],
...
public:
	...
	Computed_field_curvature_anisotropic_diffusion_image_filter_Functor(
		Computed_field_curvature_anisotropic_diffusion_image_filter *curvature_anisotropic_diffusion_image_filter) :
		computed_field_image_filter_FunctorTmpl< ImageType >(curvature_anisotropic_diffusion_image_filter),
...
void Computed_field_curvature_anisotropic_diffusion_image_filter::create_functor()
{
...
struct Computed_field *cmzn_fieldmodule_create_field_imagefilter_curvature_anisotropic_diffusion(
	...
	struct Computed_field *source_field, double timeStep, double conductance, int numIterations)
{
	...
	if (source_field && Computed_field_is_scalar(source_field, (void *)NULL))
	{
		field = Computed_field_create_generic(field_module,
			...
			new Computed_field_curvature_anisotropic_diffusion_image_filter(
				source_field, timeStep, conductance, numIterations));
	}
	else
	{
		display_message(ERROR_MESSAGE,
			"cmzn_fieldmodule_create_field_imagefilter_curvature_anisotropic_diffusion.  Invalid argument(s)");
	}

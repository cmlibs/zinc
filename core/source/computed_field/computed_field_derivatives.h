...
#define Computed_field_create_gradient Cmiss_field_module_create_gradient
#define Computed_field_create_divergence Cmiss_field_module_create_divergence
#define Computed_field_create_curl Cmiss_field_module_create_curl
#define Computed_field_create_derivative Cmiss_field_module_create_derivative

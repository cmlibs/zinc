...
public:
	...
	enum RenderPolygonMode
	{
		...
		RENDER_POLYGON_SHADED = CMZN_GRAPHICS_RENDER_POLYGON_SHADED,
		RENDER_POLYGON_WIREFRAME = CMZN_GRAPHICS_RENDER_POLYGON_WIREFRAME
	};

	enum SelectMode
	{
		SELECT_MODE_INVALID = CMZN_GRAPHICS_SELECT_MODE_INVALID,
		SELECT_ON = CMZN_GRAPHICS_SELECT_ON,
		NO_SELECT = CMZN_GRAPHICS_NO_SELECT,
		DRAW_SELECTED = CMZN_GRAPHICS_DRAW_SELECTED,
		DRAW_UNSELECTED = CMZN_GRAPHICS_DRAW_UNSELECTED
	};

	enum Type
	{
		TYPE_INVALID = CMZN_GRAPHICS_TYPE_INVALID,
		POINTS = CMZN_GRAPHICS_POINTS,
		LINES = CMZN_GRAPHICS_LINES,
		SURFACES = CMZN_GRAPHICS_SURFACES,
		CONTOURS = CMZN_GRAPHICS_CONTOURS,
		STREAMLINES = CMZN_GRAPHICS_STREAMLINES
	};
...
public:
	...
	enum TrackDirection
	{
		...
		FORWARD_TRACK = CMZN_GRAPHICS_STREAMLINES_FORWARD_TRACK,
		REVERSE_TRACK = CMZN_GRAPHICS_STREAMLINES_REVERSE_TRACK
	};
...
public:
	...
	enum Shape
	{
		SHAPE_INVALID = CMZN_GRAPHICSLINEATTRIBUTES_SHAPE_INVALID,
		SHAPE_LINE = CMZN_GRAPHICSLINEATTRIBUTES_SHAPE_LINE,
		SHAPE_RIBBON = CMZN_GRAPHICSLINEATTRIBUTES_SHAPE_RIBBON,
		SHAPE_CIRCLE_EXTRUSION = CMZN_GRAPHICSLINEATTRIBUTES_SHAPE_CIRCLE_EXTRUSION,
		SHAPE_SQUARE_EXTRUSION = CMZN_GRAPHICSLINEATTRIBUTES_SHAPE_SQUARE_EXTRUSION
	};
	...
	Shape getShape()
	{
		return static_cast<Shape>(cmzn_graphicslineattributes_get_shape(id));
	}

	int setShape(Shape shape)
	{
		return cmzn_graphicslineattributes_set_shape(id, static_cast<cmzn_graphicslineattributes_shape>(shape));
	}

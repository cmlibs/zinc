...
public:
	...
	enum FunctionType
	{
		...
		FUNCTION_CONSTANT = CMZN_ELEMENTBASIS_FUNCTION_CONSTANT,
		FUNCTION_LINEAR_LAGRANGE = CMZN_ELEMENTBASIS_FUNCTION_LINEAR_LAGRANGE,
		FUNCTION_QUADRATIC_LAGRANGE = CMZN_ELEMENTBASIS_FUNCTION_QUADRATIC_LAGRANGE,
		FUNCTION_CUBIC_LAGRANGE = CMZN_ELEMENTBASIS_FUNCTION_CUBIC_LAGRANGE,
		FUNCTION_LINEAR_SIMPLEX = CMZN_ELEMENTBASIS_FUNCTION_LINEAR_SIMPLEX,   /**< linked on 2 or more dimensions */
		FUNCTION_QUADRATIC_SIMPLEX = CMZN_ELEMENTBASIS_FUNCTION_QUADRATIC_SIMPLEX, /**< linked on 2 or more dimensions */
		FUNCTION_CUBIC_HERMITE = CMZN_ELEMENTBASIS_FUNCTION_CUBIC_HERMITE
	};

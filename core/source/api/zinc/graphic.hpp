...
public:
	...
	enum Type
	{
		TYPE_INVALID = CMISS_GRAPHIC_TYPE_INVALID,
		POINTS = CMISS_GRAPHIC_POINTS,
		LINES = CMISS_GRAPHIC_LINES,
		SURFACES = CMISS_GRAPHIC_SURFACES,
		CONTOURS = CMISS_GRAPHIC_CONTOURS,

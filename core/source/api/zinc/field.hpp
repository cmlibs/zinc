...
public:
	...
	enum DomainType
	{
		...
		DOMAIN_MESH_1D = CMISS_FIELD_DOMAIN_MESH_1D,
		DOMAIN_MESH_2D = CMISS_FIELD_DOMAIN_MESH_2D,
		DOMAIN_MESH_3D = CMISS_FIELD_DOMAIN_MESH_3D,
		DOMAIN_MESH_HIGHEST_DIMENSION = CMISS_FIELD_DOMAIN_MESH_HIGHEST_DIMENSION
	};
